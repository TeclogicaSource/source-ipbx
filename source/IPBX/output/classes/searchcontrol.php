...
class SearchControl {
	...
	{		
		$html = '<img style="visibility: hidden;" id = "'.$this->getDelButtonId($fName, $recId).'" class="searchPanelButton" src="images/search/closeRed.gif" alt="'."Elimina o controle".'"  onclick="searchController'.$this->id.'.delCtrl(\''.htmlspecialchars(jsreplace($fName)).'\', '.$recId.');">';
		return $html;
	}
