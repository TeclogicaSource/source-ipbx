...
class CrossTableReport
{
	...
	public function isProjectDB()
	{
		...
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("ipbx_ugrights" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
		...
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("cc_receptivo_filas_atend" == $this->xml_array['tables'][0])
			$isDB = true;
		if("cc_receptivo_filas_atend" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("conta" == $this->xml_array['tables'][0])
			$isDB = true;
		if("cdr" == $this->xml_array['tables'][0])
			$isDB = true;
		if("conta" == $this->xml_array['tables'][0])
			$isDB = true;
		if("cdr" == $this->xml_array['tables'][0])
		...
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("ipbx_ramais" == $this->xml_array['tables'][0])
			$isDB = true;
		if("ipbx_ramais" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
		...
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("ipbx_backup" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
		...
		if("conta" == $this->xml_array['tables'][0])
			$isDB = true;
		if("cc_receptivo_n_atend" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("ipbx_pesquisa_ura_rev_resp" == $this->xml_array['tables'][0])
			$isDB = true;
		if("ipbx_fila_ura_rev" == $this->xml_array['tables'][0])
			$isDB = true;
		if("ipbx_fila_pesquisa_ura_rev_resp" == $this->xml_array['tables'][0])
			$isDB = true;
		if("timeout" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
		...
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("centrocusto" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
		...
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("v_rel_detalhado_agentes" == $this->xml_array['tables'][0])
			$isDB = true;
		if("v_produt_filas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("v_rel_detalhado_agentes" == $this->xml_array['tables'][0])
			$isDB = true;
		if("v_graf_perf_temp_espera_dia" == $this->xml_array['tables'][0])
			$isDB = true;
		if("v_rel_hist_fila_data" == $this->xml_array['tables'][0])
			$isDB = true;
		if("v_rel_hist_fila_data_hora" == $this->xml_array['tables'][0])
			$isDB = true;
		if("v_rel_hist_fila_data" == $this->xml_array['tables'][0])
			$isDB = true;
		if("v_rel_hist_fila_data_hora" == $this->xml_array['tables'][0])
		...
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("v_graf_perf_temp_atendimento" == $this->xml_array['tables'][0])
			$isDB = true;
		if("v_produt_filas_grupo_data" == $this->xml_array['tables'][0])
			$isDB = true;
		if("v_produt_filas_grupo_mes" == $this->xml_array['tables'][0])
			$isDB = true;
		if("v_graf_perf_temp_atendimento" == $this->xml_array['tables'][0])
			$isDB = true;
		if("v_rel_prod_agentes_dia" == $this->xml_array['tables'][0])
			$isDB = true;
		if("v_rel_disp_agente" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("" == $this->xml_array['tables'][0])
		...
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("ipbx_quadro_avisos" == $this->xml_array['tables'][0])
			$isDB = true;
		return $isDB;
	}
