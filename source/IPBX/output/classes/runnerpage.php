...
class RunnerPage
{
	...
	function getTextVariables()
	{
		...
		{
			$generalCode.="\nwindow.TEXT_FIRST = '".jsreplace("Primeiro")."';".
			"\nwindow.TEXT_PREVIOUS = '".jsreplace("Anterior")."';".
			"\nwindow.TEXT_NEXT = '".jsreplace("Próximo")."';".
			"\nwindow.TEXT_LAST = '".jsreplace("Último")."';".
			"\nwindow.TEXT_PROCEED_TO = '".jsreplace("Prossiga para")."';".
			"\nwindow.TEXT_DETAIL_NOT_SAVED = '".jsreplace("Registros em %s não foram salvos")."';".
			"\nwindow.TEXT_DETAIL_GOTO = '".jsreplace("Ir para")."';".
			"\nwindow.TEXT_SHOW_ALL = '".jsreplace("Mostrar Todos")."';";
		}	
		...
		{
			$generalCode.="window.TEXT_MONTH_JAN='".jsreplace("Janeiro")."';\r\n";
			$generalCode.="window.TEXT_MONTH_FEB='".jsreplace("Fevereiro")."';\r\n";
			$generalCode.="window.TEXT_MONTH_MAR='".jsreplace("Março")."';\r\n";
			$generalCode.="window.TEXT_MONTH_APR='".jsreplace("Abril")."';\r\n";
			$generalCode.="window.TEXT_MONTH_MAY='".jsreplace("Maio")."';\r\n";
			$generalCode.="window.TEXT_MONTH_JUN='".jsreplace("Junho")."';\r\n";
			$generalCode.="window.TEXT_MONTH_JUL='".jsreplace("Julho")."';\r\n";
			$generalCode.="window.TEXT_MONTH_AUG='".jsreplace("Agosto")."';\r\n";
			$generalCode.="window.TEXT_MONTH_SEP='".jsreplace("Setembro")."';\r\n";
			$generalCode.="window.TEXT_MONTH_OCT='".jsreplace("Outubro")."';\r\n";
			$generalCode.="window.TEXT_MONTH_NOV='".jsreplace("Novembro")."';\r\n";
			$generalCode.="window.TEXT_MONTH_DEC='".jsreplace("Dezembro")."';\r\n";
			$generalCode.="window.TEXT_DAY_SU='".jsreplace("Dom")."';\r\n";
			$generalCode.="window.TEXT_DAY_MO='".jsreplace("Seg")."';\r\n";
			$generalCode.="window.TEXT_DAY_TU='".jsreplace("Ter")."';\r\n";
			$generalCode.="window.TEXT_DAY_WE='".jsreplace("Qua")."';\r\n";
			$generalCode.="window.TEXT_DAY_TH='".jsreplace("Qui")."';\r\n";
			$generalCode.="window.TEXT_DAY_FR='".jsreplace("Sex")."';\r\n";
			$generalCode.="window.TEXT_DAY_SA='".jsreplace("Sab")."';\r\n";
			$generalCode.="window.TEXT_TODAY='".jsreplace("hoje")."';\r\n";
			$generalCode.="window.TEXT_SELECT_DATE = '".jsreplace("Selecione a Data")."';\r\n";
			$generalCode.="window.TEXT_INVALID_CAPTCHA_CODE='".jsreplace("Código de segurança inválido")."';\r\n";
		}
		...
		if($this->pageType == PAGE_EDIT || $this->pageType == PAGE_ADD || $this->pageType == PAGE_SEARCH || $this->pageType == PAGE_REGISTER)
		{
			...
			$generalCode.="window.TEXT_INLINE_FIELD_REQUIRED='".jsreplace("Campo requerido")."';\r\n";
			$generalCode.="window.TEXT_INLINE_FIELD_ZIPCODE='".jsreplace("Campo deve ter um código postal válido (Zipcode)")."';\r\n";
			$generalCode.="window.TEXT_INLINE_FIELD_EMAIL='".jsreplace("Campo deve ter um endereço de E-mail válido")."';\r\n";
			$generalCode.="window.TEXT_INLINE_FIELD_NUMBER='".jsreplace("Campo deve ser um número")."';\r\n";
			$generalCode.="window.TEXT_INLINE_FIELD_CURRENCY='".jsreplace("Campo deve ser em moeda")."';\r\n";
			$generalCode.="window.TEXT_INLINE_FIELD_PHONE='".jsreplace("Campo deve ter um número de Telefone válido")."';\r\n";
			$generalCode.="window.TEXT_INLINE_FIELD_PASSWORD1='".jsreplace("Campo não pode ser do tipo ")."';\r\n";
			$generalCode.="window.TEXT_INLINE_FIELD_PASSWORD2='".jsreplace("Campo deve ter pelo menos 4 caracteres")."';\r\n";
			$generalCode.="window.TEXT_INLINE_FIELD_STATE='".jsreplace("Campo deve ser um nome de Estado")."';\r\n";
			$generalCode.="window.TEXT_INLINE_FIELD_SSN='".jsreplace("Campo deve ser um número de ")."';\r\n";
			$generalCode.="window.TEXT_INLINE_FIELD_DATE='".jsreplace("Campo deve ter uma data válida")."';\r\n";
			$generalCode.="window.TEXT_INLINE_FIELD_TIME='".jsreplace("Campo deve ter horário no formato de 24 horas")."';\r\n";
			$generalCode.="window.TEXT_INLINE_FIELD_CC='".jsreplace("Campo de ter um número de Cartão de Crédito válido")."';\r\n";
			$generalCode.="window.TEXT_INLINE_FIELD_SSN='".jsreplace("Campo deve ser um número de ")."';\r\n";			
		}

		$generalCode.="\nwindow.TEXT_PLEASE_SELECT='".jsreplace("Favor Selecionar")."';";
		...
		$generalCode.="\nwindow.TEXT_CTRL_CLICK = \""."CTRL + click para classificação múltipla"."\";".
		"\nwindow.TEXT_SAVE='".jsreplace("Salvar")."';".
		"\nwindow.TEXT_CANCEL='".jsreplace("Cancela")."';".
		"\nwindow.TEXT_INLINE_ERROR='".jsreplace("Ocorreu um erro!")."';".
		"\nwindow.TEXT_PREVIEW='".jsreplace("prévia")."';".
		"\nwindow.TEXT_HIDE='".jsreplace("ocultar")."';".
		"\nwindow.TEXT_LOADING='".jsreplace("Carregando")."';";
