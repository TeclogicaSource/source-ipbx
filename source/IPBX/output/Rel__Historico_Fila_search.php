...
include("include/Rel__Historico_Fila_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Rel__Historico_Fila_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Rel__Historico_Fila_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Rel__Historico_Fila';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Historico Fila";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Rel__Historico_Fila_report.php\" ";
	}
