...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Telefone_discado",
...
$params['shortTName'] = "Telefone_discado";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Telefone_discado_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Telefone_discado_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Telefone_discado_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Telefone_discado_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Telefone_discado_report.htm";
