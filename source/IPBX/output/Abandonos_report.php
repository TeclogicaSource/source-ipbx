...
$fieldArr['goodName'] = "_Entrada_Saida_";
$fieldArr['repPage'] = "0";
$fieldArr['viewFormat'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "hr_abandono";
$fieldArr['goodName'] = "hr_abandono";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "Time";
$fieldArr['editFormat'] = "Time";
$fieldArr['thumbnail'] = "";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Abandonos_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Abandonos_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Abandonos_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Abandonos_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Abandonos_report.htm";
