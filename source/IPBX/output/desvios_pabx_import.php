...
// keys array
$keys[]=AddFieldWrappers("id_desvio");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"desvios_pabx_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='desvios_pabx_list.php?a=return';\"");
...
$xt->display("desvios_pabx_import.htm");
