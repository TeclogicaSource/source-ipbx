...
//	idt_cadeado - 
			$value="";
				$value = ProcessLargeText(GetData($data,"idt_cadeado", ""),"field=idt%5Fcadeado".$keylink,"",MODE_PRINT);
			$record["idt_cadeado_value"]=$value;
...
$xt->assign("idt_cadeado_fieldheadercolumn",true);
$xt->assign("idt_cadeado_fieldheader",true);
$xt->assign("idt_cadeado_fieldcolumn",true);
$xt->assign("idt_cadeado_fieldfootercolumn",true);
...
$templatefile = "cadeado_print.htm";
