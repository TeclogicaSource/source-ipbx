...
// keys array
$keys[]=AddFieldWrappers("id_ramal_horario");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"sip_buddies_horario_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='sip_buddies_horario_list.php?a=return';\"");
...
$xt->display("sip_buddies_horario_import.htm");
