...
$mode=SEARCH_SIMPLE;
$templatefile = "cc_receptivo_filas_horario_desv_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "cc_receptivo_filas_horario_desv_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'cc_receptivo_filas_horario_desv';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "cc_receptivo_filas_horario_desv";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("dsc_desvio");
	...
	{
		$firstFieldParams['fName'] = "dsc_desvio";
	...
	$xt->assignbyref("dsc_desvio_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("dsc_desvio_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("dsc_desvio_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_dsc_desvio", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("dsc_desvio", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("dsc_desvio")."', ".$pageObject->id.", ".$ctrlsMap.");";
	...
	{
	$contents_block["begin"].="action=\"cc_receptivo_filas_horario_desv_list.php\" ";
	}
