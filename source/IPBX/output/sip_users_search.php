...
$mode=SEARCH_SIMPLE;
$templatefile = "sip_users_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "sip_users_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'sip_users';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "sip_users";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"sip_users_list.php\" ";
	}
