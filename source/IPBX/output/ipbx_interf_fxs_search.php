...
$mode=SEARCH_SIMPLE;
$templatefile = "ipbx_interf_fxs_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "ipbx_interf_fxs_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'ipbx_interf_fxs';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "ipbx_interf_fxs";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("khomp_interf");
	...
	{
		$firstFieldParams['fName'] = "khomp_interf";
	...
	if(isEnableSection508())
		$xt->assign_section("khomp_interf_label","<label for=\"".GetInputElementId("khomp_interf", $id)."\">","</label>");
	else 
		$xt->assign("khomp_interf_label", true);
	
	$xt->assign("khomp_interf_fieldblock", true);		
	$xt->assignbyref("khomp_interf_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("khomp_interf_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("khomp_interf_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_khomp_interf", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("khomp_interf", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("khomp_interf")."', ".$pageObject->id.", ".$ctrlsMap.");";
	...
	{
	$contents_block["begin"].="action=\"ipbx_interf_fxs_list.php\" ";
	}
