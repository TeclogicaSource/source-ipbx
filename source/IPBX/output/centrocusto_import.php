...
// keys array
$keys[]=AddFieldWrappers("idt_custo");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"centrocusto_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='centrocusto_list.php?a=return';\"");
...
$xt->display("centrocusto_import.htm");
