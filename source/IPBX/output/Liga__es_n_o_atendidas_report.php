...
include("include/Liga__es_n_o_atendidas_variables.php");
...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Liga__es_n_o_atendidas",
...
$params['shortTName'] = "Liga__es_n_o_atendidas";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Liga__es_n_o_atendidas_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Liga__es_n_o_atendidas_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Liga__es_n_o_atendidas_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Liga__es_n_o_atendidas_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Liga__es_n_o_atendidas_report.htm";
