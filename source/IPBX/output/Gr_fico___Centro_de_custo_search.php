...
include("include/Gr_fico___Centro_de_custo_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Gr_fico___Centro_de_custo_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Gr_fico___Centro_de_custo_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Gr_fico___Centro_de_custo';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Graf. Centro de custo";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Gr_fico___Centro_de_custo_chart.php\" ";
	}
