...
// keys array
$keys[]=AddFieldWrappers("id_canal");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"ipbx_canais_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='ipbx_canais_list.php?a=return';\"");
...
$xt->display("ipbx_canais_import.htm");
