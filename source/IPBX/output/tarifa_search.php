...
$mode=SEARCH_SIMPLE;
$templatefile = "tarifa_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "tarifa_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'tarifa';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "tarifa";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("dsc_tarifa");
	...
	{
		$firstFieldParams['fName'] = "dsc_tarifa";
	...
	if(isEnableSection508())
		$xt->assign_section("dsc_tarifa_label","<label for=\"".GetInputElementId("dsc_tarifa", $id)."\">","</label>");
	else 
		$xt->assign("dsc_tarifa_label", true);
	
	$xt->assign("dsc_tarifa_fieldblock", true);		
	$xt->assignbyref("dsc_tarifa_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("dsc_tarifa_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("dsc_tarifa_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_dsc_tarifa", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("dsc_tarifa", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("dsc_tarifa")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("vlr_unid");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "vlr_unid";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("vlr_unid_label","<label for=\"".GetInputElementId("vlr_unid", $id)."\">","</label>");
	else 
		$xt->assign("vlr_unid_label", true);
	
	$xt->assign("vlr_unid_fieldblock", true);		
	$xt->assignbyref("vlr_unid_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("vlr_unid_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("vlr_unid_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_vlr_unid", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("vlr_unid", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("vlr_unid")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("cad_inicial");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "cad_inicial";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("cad_inicial_label","<label for=\"".GetInputElementId("cad_inicial", $id)."\">","</label>");
	else 
		$xt->assign("cad_inicial_label", true);
	
	$xt->assign("cad_inicial_fieldblock", true);		
	$xt->assignbyref("cad_inicial_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("cad_inicial_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("cad_inicial_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_cad_inicial", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("cad_inicial", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("cad_inicial")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("cad_frac");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "cad_frac";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("cad_frac_label","<label for=\"".GetInputElementId("cad_frac", $id)."\">","</label>");
	else 
		$xt->assign("cad_frac_label", true);
	
	$xt->assign("cad_frac_fieldblock", true);		
	$xt->assignbyref("cad_frac_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("cad_frac_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("cad_frac_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_cad_frac", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("cad_frac", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("cad_frac")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	...
	{
	$contents_block["begin"].="action=\"tarifa_list.php\" ";
	}
