...
$mode=SEARCH_SIMPLE;
$templatefile = "cc_agentes_fila_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "cc_agentes_fila_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'cc_agentes_fila';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "cc_agentes_fila";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("flg_req_aux");
	...
	{
		$firstFieldParams['fName'] = "flg_req_aux";
	...
	if(isEnableSection508())
		$xt->assign_section("flg_req_aux_label","<label for=\"".GetInputElementId("flg_req_aux", $id)."\">","</label>");
	else 
		$xt->assign("flg_req_aux_label", true);
	
	$xt->assign("flg_req_aux_fieldblock", true);		
	$xt->assignbyref("flg_req_aux_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("flg_req_aux_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("flg_req_aux_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_flg_req_aux", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("flg_req_aux", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("flg_req_aux")."', ".$pageObject->id.", ".$ctrlsMap.");";
	...
	{
	$contents_block["begin"].="action=\"cc_agentes_fila_list.php\" ";
	}
