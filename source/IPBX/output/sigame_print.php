...
//	idt_siga - 
			$value="";
				$value = ProcessLargeText(GetData($data,"idt_siga", ""),"field=idt%5Fsiga".$keylink,"",MODE_PRINT);
			$record["idt_siga_value"]=$value;
...
$xt->assign("idt_siga_fieldheadercolumn",true);
$xt->assign("idt_siga_fieldheader",true);
$xt->assign("idt_siga_fieldcolumn",true);
$xt->assign("idt_siga_fieldfootercolumn",true);
