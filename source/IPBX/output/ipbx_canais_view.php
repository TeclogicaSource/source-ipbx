...
$arr = array();
$arr['fName'] = "id_canal";
$arr['viewFormat'] = ViewFormat("id_canal", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "canal";
$arr['viewFormat'] = ViewFormat("canal", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "flg_utilizado";
$arr['viewFormat'] = ViewFormat("flg_utilizado", $strTableName);
$fieldsArr[] = $arr;
...
//id_canal - 
	$value="";
	$value = ProcessLargeText(GetData($data,"id_canal", ""),"","",MODE_VIEW);
	$xt->assign("id_canal_value",$value);
	$xt->assign("id_canal_fieldblock",true);
////////////////////////////////////////////
//canal - 
	$value="";
	$value = ProcessLargeText(GetData($data,"canal", ""),"","",MODE_VIEW);
	$xt->assign("canal_value",$value);
	$xt->assign("canal_fieldblock",true);
////////////////////////////////////////////
//flg_utilizado - 
	$value="";
	$value = ProcessLargeText(GetData($data,"flg_utilizado", ""),"","",MODE_VIEW);
	$xt->assign("flg_utilizado_value",$value);
	$xt->assign("flg_utilizado_fieldblock",true);
 


$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("id_canal")."': '".(jsreplace(@$data["id_canal"]))."', ";
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='ipbx_canais_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='ipbx_canais_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "ipbx_canais_view.htm";
