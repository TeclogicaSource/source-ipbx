...
$arr = array();
$arr['fName'] = "vlr_unid";
$arr['viewFormat'] = ViewFormat("vlr_unid", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "cad_inicial";
$arr['viewFormat'] = ViewFormat("cad_inicial", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "cad_frac";
$arr['viewFormat'] = ViewFormat("cad_frac", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "seg";
...
//vlr_unid - Currency
	$value="";
	$value = ProcessLargeText(GetData($data,"vlr_unid", "Currency"),"","",MODE_VIEW);
	$xt->assign("vlr_unid_value",$value);
	$xt->assign("vlr_unid_fieldblock",true);
////////////////////////////////////////////
//cad_inicial - Number
	$value="";
	$value = ProcessLargeText(GetData($data,"cad_inicial", "Number"),"","",MODE_VIEW);
	$xt->assign("cad_inicial_value",$value);
	$xt->assign("cad_inicial_fieldblock",true);
////////////////////////////////////////////
//cad_frac - Number
	$value="";
	$value = ProcessLargeText(GetData($data,"cad_frac", "Number"),"","",MODE_VIEW);
	$xt->assign("cad_frac_value",$value);
...
$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("IDT_TARIFA")."': '".(jsreplace(@$data["IDT_TARIFA"]))."', ";
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='tarifa_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='tarifa_view.php?".$prevlink."'\"");
	}
    else 
