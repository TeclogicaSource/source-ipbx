...
$mode=SEARCH_SIMPLE;
$templatefile = "Rel__Centro_de_custo_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Rel__Centro_de_custo_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Rel__Centro_de_custo';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Centro de custo";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Rel__Centro_de_custo_report.php\" ";
	}
