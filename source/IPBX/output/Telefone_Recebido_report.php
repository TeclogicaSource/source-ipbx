...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Telefone_Recebido",
...
$params['shortTName'] = "Telefone_Recebido";
...
$fieldArr = array();
$fieldArr['name'] = "idt_agenda";
$fieldArr['goodName'] = "idt_agenda";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "Numero";
$fieldArr['goodName'] = "Numero";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Telefone_Recebido_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Telefone_Recebido_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Telefone_Recebido_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Telefone_Recebido_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Telefone_Recebido_report.htm";
