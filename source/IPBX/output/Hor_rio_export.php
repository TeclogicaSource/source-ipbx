...
$pageObject->body["begin"] .="<form action=\"Hor_rio_export.php\" method=POST id=frmexport name=frmexport>";
$pageObject->body["end"] .= "</form><script>".$pageObject->PrepareJS()."</script>";
$xt->assignbyref("body",$pageObject->body);

$xt->display("Hor_rio_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=Hor_rio.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=Hor_rio.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=Hor_rio.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=Hor_rio.csv");
