...
$pageObject->body["begin"] .="<form action=\"Liga__es_n_o_atendidas_export.php\" method=POST id=frmexport name=frmexport>";
$pageObject->body["end"] .= "</form><script>".$pageObject->PrepareJS()."</script>";
$xt->assignbyref("body",$pageObject->body);

$xt->display("Liga__es_n_o_atendidas_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=Liga__es_n_o_atendidas.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=Liga__es_n_o_atendidas.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=Liga__es_n_o_atendidas.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=Liga__es_n_o_atendidas.csv");
