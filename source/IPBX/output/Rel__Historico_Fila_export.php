...
$pageObject->body["begin"] .="<form action=\"Rel__Historico_Fila_export.php\" method=POST id=frmexport name=frmexport>";
$pageObject->body["end"] .= "</form><script>".$pageObject->PrepareJS()."</script>";
$xt->assignbyref("body",$pageObject->body);

$xt->display("Rel__Historico_Fila_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Historico_Fila.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Historico_Fila.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Historico_Fila.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Historico_Fila.csv");
