...
if($mastertable=="ipbx_horario_desv")
{
	$where ="";
...
if ( $rowcount ) {
	...
	//	dsv_01 - 
		    $value="";
				$value = ProcessLargeText(GetData($data,"dsv_01", ""),"field=dsv%5F01".$keylink,"",MODE_PRINT);
			$row["dsv_01_value"]=$value;
	//	hr_inicio_02 - Time
		    $value="";
	...
	//	dsv_02 - 
		    $value="";
				$value = ProcessLargeText(GetData($data,"dsv_02", ""),"field=dsv%5F02".$keylink,"",MODE_PRINT);
			$row["dsv_02_value"]=$value;
	//	hr_inicio_03 - Time
		    $value="";
	...
	//	dsv_03 - 
		    $value="";
				$value = ProcessLargeText(GetData($data,"dsv_03", ""),"field=dsv%5F03".$keylink,"",MODE_PRINT);
			$row["dsv_03_value"]=$value;
	//	hr_inicio_04 - Time
		    $value="";
	...
	//	dsv_04 - 
		    $value="";
				$value = ProcessLargeText(GetData($data,"dsv_04", ""),"field=dsv%5F04".$keylink,"",MODE_PRINT);
			$row["dsv_04_value"]=$value;
	$rowinfo[]=$row;
	}
	$xt->assign_loopsection("details_row",$rowinfo);
} else {
}
$xt->display("ipbx_horario_desv_ramais_detailspreview.htm");
if($mode!="inline")
