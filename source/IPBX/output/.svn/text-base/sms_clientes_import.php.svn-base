...
// keys array
$keys[]=AddFieldWrappers("id_cliente");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"sms_clientes_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='sms_clientes_list.php?a=return';\"");
...
$xt->display("sms_clientes_import.htm");
