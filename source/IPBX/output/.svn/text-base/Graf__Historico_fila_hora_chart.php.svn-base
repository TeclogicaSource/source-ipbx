...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Graf__Historico_fila_hora",
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Graf__Historico_fila_hora_search.php';return false;\"");
$xt->assign("search_records_block",true);
//$xt->assign("recordcontrols_block",true);

$xt->assign("searchform_showall",true);
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Graf__Historico_fila_hora_chart.php?a=showall';\"");

if(!GetChartXML("Graf__Historico_fila_hora"))
...
$templatefile = "Graf__Historico_fila_hora_chart.htm";
