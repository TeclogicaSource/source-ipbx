...
//	id_interf_vono - 
			$value="";
				$value = ProcessLargeText(GetData($data,"id_interf_vono", ""),"field=id%5Finterf%5Fvono".$keylink,"",MODE_PRINT);
			$record["id_interf_vono_value"]=$value;
...
//	include proper masterprint.php code
	...
	$params=array("detailtable"=>"interf_vono","keys"=>$masterkeys);
	$master=array();
...
$xt->assign("id_interf_vono_fieldheadercolumn",true);
$xt->assign("id_interf_vono_fieldheader",true);
$xt->assign("id_interf_vono_fieldcolumn",true);
$xt->assign("id_interf_vono_fieldfootercolumn",true);
...
$templatefile = "interf_vono_print.htm";
