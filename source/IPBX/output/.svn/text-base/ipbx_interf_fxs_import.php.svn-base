...
$strOriginalTableName="`ipbx_interf_fxs`";
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"ipbx_interf_fxs_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='ipbx_interf_fxs_list.php?a=return';\"");
...
$xt->display("ipbx_interf_fxs_import.htm");
