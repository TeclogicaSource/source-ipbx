...
$mode=SEARCH_SIMPLE;
$templatefile = "Relat_rio_FilaxAgente_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Relat_rio_FilaxAgente_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Relat_rio_FilaxAgente';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Fila x Agente";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Relat_rio_FilaxAgente_report.php\" ";
	}
