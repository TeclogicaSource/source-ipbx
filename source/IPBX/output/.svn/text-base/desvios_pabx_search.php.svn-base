...
$mode=SEARCH_SIMPLE;
$templatefile = "desvios_pabx_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "desvios_pabx_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'desvios_pabx';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "desvios_pabx";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"desvios_pabx_list.php\" ";
	}
