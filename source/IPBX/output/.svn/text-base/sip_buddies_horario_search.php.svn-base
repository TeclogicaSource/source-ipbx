...
$mode=SEARCH_SIMPLE;
$templatefile = "sip_buddies_horario_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "sip_buddies_horario_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'sip_buddies_horario';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "sip_buddies_horario";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"sip_buddies_horario_list.php\" ";
	}
