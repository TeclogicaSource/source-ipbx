...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Lig_Custo_por_tronco",
...
$params['shortTName'] = "Lig_Custo_por_tronco";
...
$groupField = array();
$groupField['strGroupField'] = "Interface";
...
$fieldArr = array();
$fieldArr['name'] = "Interface";
$fieldArr['goodName'] = "Interface";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "c.origem";
$fieldArr['goodName'] = "c_origem";
$fieldArr['repPage'] = "0";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Lig_Custo_por_tronco_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Lig_Custo_por_tronco_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Lig_Custo_por_tronco_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Lig_Custo_por_tronco_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Lig_Custo_por_tronco_report.htm";
