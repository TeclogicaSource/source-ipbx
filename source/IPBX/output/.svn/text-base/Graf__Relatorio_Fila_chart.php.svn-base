...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Graf__Relatorio_Fila",
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Graf__Relatorio_Fila_search.php';return false;\"");
$xt->assign("search_records_block",true);
//$xt->assign("recordcontrols_block",true);

$xt->assign("searchform_showall",true);
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Graf__Relatorio_Fila_chart.php?a=showall';\"");

if(!GetChartXML("Graf__Relatorio_Fila"))
...
$templatefile = "Graf__Relatorio_Fila_chart.htm";
