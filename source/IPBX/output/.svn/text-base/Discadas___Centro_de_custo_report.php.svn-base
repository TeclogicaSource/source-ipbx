...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Discadas___Centro_de_custo",
...
$params['shortTName'] = "Discadas___Centro_de_custo";
...
$groupField = array();
$groupField['strGroupField'] = "dsc_centro_cust";
...
$fieldArr = array();
$fieldArr['name'] = "calldate";
$fieldArr['goodName'] = "calldate";
$fieldArr['repPage'] = "1";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "Origem";
$fieldArr['goodName'] = "Origem";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "destino";
$fieldArr['goodName'] = "destino";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "duracao";
$fieldArr['goodName'] = "duracao";
$fieldArr['repPage'] = "1";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "dsc_interf";
$fieldArr['goodName'] = "dsc_interf";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "idt_custo";
$fieldArr['goodName'] = "idt_custo";
$fieldArr['repPage'] = "0";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Discadas___Centro_de_custo_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Discadas___Centro_de_custo_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Discadas___Centro_de_custo_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Discadas___Centro_de_custo_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Discadas___Centro_de_custo_report.htm";
