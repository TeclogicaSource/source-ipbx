...
$mode=SEARCH_SIMPLE;
$templatefile = "Abandonos_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Abandonos_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Abandonos';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Abandonos";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Abandonos_report.php\" ";
	}
