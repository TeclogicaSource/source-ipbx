...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Centro_de_custo",
...
$params['shortTName'] = "Centro_de_custo";
...
$fieldArr = array();
$fieldArr['name'] = "conta.calldate";
$fieldArr['goodName'] = "conta_calldate";
$fieldArr['repPage'] = "1";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "Centro de custos";
$fieldArr['goodName'] = "Centro_de_custos";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "mes_referencia";
$fieldArr['goodName'] = "mes_referencia";
$fieldArr['repPage'] = "0";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Lookup wizard";
$fieldArr['thumbnail'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "ano_referencia";
$fieldArr['goodName'] = "ano_referencia";
$fieldArr['repPage'] = "0";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Lookup wizard";
$fieldArr['thumbnail'] = "";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Centro_de_custo_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Centro_de_custo_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Centro_de_custo_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Centro_de_custo_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Centro_de_custo_report.htm";
