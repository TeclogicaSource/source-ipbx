...
//	id_canal - 
			$value="";
				$value = ProcessLargeText(GetData($data,"id_canal", ""),"field=id%5Fcanal".$keylink,"",MODE_PRINT);
			$record["id_canal_value"]=$value;

//	canal - 
			$value="";
				$value = ProcessLargeText(GetData($data,"canal", ""),"field=canal".$keylink,"",MODE_PRINT);
			$record["canal_value"]=$value;

//	flg_utilizado - 
			$value="";
				$value = ProcessLargeText(GetData($data,"flg_utilizado", ""),"field=flg%5Futilizado".$keylink,"",MODE_PRINT);
			$record["flg_utilizado_value"]=$value;
			if($col<$colsonpage)
...
$masterkeys=array();
if($mastertable=="ipbx_interf_fxs")
{
//	include proper masterprint.php code
	include("include/ipbx_interf_fxs_masterprint.php");
	$masterkeys[]=@$_SESSION[$strTableName."_masterkey1"];
	$params=array("detailtable"=>"ipbx_canais","keys"=>$masterkeys);
	$master=array();
	$master["func"]="DisplayMasterTableInfo_ipbx_interf_fxs";
...
$xt->assign("id_canal_fieldheadercolumn",true);
$xt->assign("id_canal_fieldheader",true);
$xt->assign("id_canal_fieldcolumn",true);
$xt->assign("id_canal_fieldfootercolumn",true);
$xt->assign("canal_fieldheadercolumn",true);
$xt->assign("canal_fieldheader",true);
$xt->assign("canal_fieldcolumn",true);
$xt->assign("canal_fieldfootercolumn",true);
$xt->assign("flg_utilizado_fieldheadercolumn",true);
$xt->assign("flg_utilizado_fieldheader",true);
$xt->assign("flg_utilizado_fieldcolumn",true);
$xt->assign("flg_utilizado_fieldfootercolumn",true);
...
$templatefile = "ipbx_canais_print.htm";
