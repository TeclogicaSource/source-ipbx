...
$mode=SEARCH_SIMPLE;
$templatefile = "Rel__Produt_filas_grupo_por_mes_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Rel__Produt_filas_grupo_por_mes_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Rel__Produt_filas_grupo_por_mes';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Produt filas grupo por mes";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Rel__Produt_filas_grupo_por_mes_report.php\" ";
	}
