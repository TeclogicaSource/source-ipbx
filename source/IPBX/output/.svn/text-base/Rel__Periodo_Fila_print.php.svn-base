...
$params['shortTName'] = "Rel__Periodo_Fila";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "logados";
$fieldArr['goodName'] = "logados";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "pausados";
$fieldArr['goodName'] = "pausados";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "atendendo";
$fieldArr['goodName'] = "atendendo";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "discando";
$fieldArr['goodName'] = "discando";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
$xt->assign("hr_entrada_fieldheader",true);
$xt->assign("logados_fieldheader",true);
$xt->assign("pausados_fieldheader",true);
$xt->assign("atendendo_fieldheader",true);
$xt->assign("discando_fieldheader",true);
...
$templatefile = "Rel__Periodo_Fila_print.htm";
