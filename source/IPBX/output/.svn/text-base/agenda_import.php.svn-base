...
// keys array
$keys[]=AddFieldWrappers("idt_agenda");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"agenda_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='agenda_list.php?a=return';\"");
