...
$mode=SEARCH_SIMPLE;
$templatefile = "Rel__Desvios_Chamadas_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Rel__Desvios_Chamadas_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Rel__Desvios_Chamadas';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Desvios Chamadas";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Rel__Desvios_Chamadas_report.php\" ";
	}
