...
$xt->assign("calldate_fieldheader",true);
$xt->assign("clid_fieldheader",true);
$xt->assign("src_fieldheader",true);
$xt->assign("dst_fieldheader",true);
$xt->assign("duration_fieldheader",true);
$xt->assign("disposition_fieldheader",true);
$xt->assign("Audio_fieldheader",true);
...
$templatefile = "Recebidas_print.htm";
