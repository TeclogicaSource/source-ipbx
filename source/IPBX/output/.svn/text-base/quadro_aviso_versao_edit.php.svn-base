...
require_once("include/quadro_aviso_versao_variables.php");
...
$layout = new TLayout("edit_vmenu", "Avenue1Avenue", "MobileAvenue");
$layout->version = 2;
...
$layout->blocks["left"][] = "menu";
$page_layouts["quadro_aviso_versao_edit"] = $layout;
...
$keys = array();
$keys["id_aviso"] = postvalue("editid1");
