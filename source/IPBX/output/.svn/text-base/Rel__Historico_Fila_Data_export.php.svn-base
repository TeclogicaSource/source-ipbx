...
$pageObject->body["begin"] .="<form action=\"Rel__Historico_Fila_Data_export.php\" method=POST id=frmexport name=frmexport>";
$pageObject->body["end"] .= "</form><script>".$pageObject->PrepareJS()."</script>";
$xt->assignbyref("body",$pageObject->body);

$xt->display("Rel__Historico_Fila_Data_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Historico_Fila_Data.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Historico_Fila_Data.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Historico_Fila_Data.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Historico_Fila_Data.csv");
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Média de Agentes Disponíveis").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Maior qtd. de agentes Disponíveis").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Maior qtd. de Agentes Pausados").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Média de Agentes Pausa").'</td>';	
	...
	else
	{
		echo "<td>"."Fila"."</td>";
		echo "<td>"."Data"."</td>";
		echo "<td>"."Média de Agentes Disponíveis"."</td>";
		echo "<td>"."Maior qtd. de agentes Disponíveis"."</td>";
		echo "<td>"."Maior qtd. de Agentes Pausados"."</td>";
		echo "<td>"."Média de Agentes Pausa"."</td>";
