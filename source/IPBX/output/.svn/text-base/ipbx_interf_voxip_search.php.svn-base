...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("qtd_cham_por_ramal");
	...
	{
		$firstFieldParams['fName'] = "qtd_cham_por_ramal";
	...
	$xt->assignbyref("qtd_cham_por_ramal_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("qtd_cham_por_ramal_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("qtd_cham_por_ramal_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_qtd_cham_por_ramal", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("qtd_cham_por_ramal", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("qtd_cham_por_ramal")."', ".$pageObject->id.", ".$ctrlsMap.");";
