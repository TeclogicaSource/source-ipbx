...
// keys array
$keys[]=AddFieldWrappers("id_desv_pref_item");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"ipbx_desv_prefix_item_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='ipbx_desv_prefix_item_list.php?a=return';\"");
...
$xt->display("ipbx_desv_prefix_item_import.htm");
