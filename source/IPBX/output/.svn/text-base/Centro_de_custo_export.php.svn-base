...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Mês Referência").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Ano Referência").'</td>';	
	}
	else
	{
		echo "<td>"."Data"."</td>";
		...
		echo "<td>"."Duração"."</td>";
		echo "<td>"."Custo"."</td>";
		echo "<td>"."Mês Referência"."</td>";
		echo "<td>"."Ano Referência"."</td>";
	}
	echo "</tr>";
