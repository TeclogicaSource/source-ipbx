...
//	dsc_conf_central - 
			...
			$record["dsc_conf_central_value"]=$value;
			if($col<$colsonpage)
...
$xt->assign("dsc_conf_central_fieldheadercolumn",true);
$xt->assign("dsc_conf_central_fieldheader",true);
$xt->assign("dsc_conf_central_fieldcolumn",true);
$xt->assign("dsc_conf_central_fieldfootercolumn",true);
...
$templatefile = "central_print.htm";
