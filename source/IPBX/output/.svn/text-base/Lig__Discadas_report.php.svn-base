...
$params['shortTName'] = "Lig__Discadas";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "Periodo";
$fieldArr['goodName'] = "Periodo";
$fieldArr['repPage'] = "0";
$fieldArr['viewFormat'] = "Datetime";
$fieldArr['editFormat'] = "Date";
$fieldArr['thumbnail'] = "";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Lig__Discadas_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Lig__Discadas_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Lig__Discadas_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Lig__Discadas_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Lig__Discadas_report.htm";
