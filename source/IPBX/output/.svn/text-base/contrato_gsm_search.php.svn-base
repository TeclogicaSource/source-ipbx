...
$mode=SEARCH_SIMPLE;
$templatefile = "contrato_gsm_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "contrato_gsm_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'contrato_gsm';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "contrato_gsm";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"contrato_gsm_list.php\" ";
	}
