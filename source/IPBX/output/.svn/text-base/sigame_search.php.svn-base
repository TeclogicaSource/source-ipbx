...
$mode=SEARCH_SIMPLE;
$templatefile = "sigame_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "sigame_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'sigame';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "sigame";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"sigame_list.php\" ";
	}
