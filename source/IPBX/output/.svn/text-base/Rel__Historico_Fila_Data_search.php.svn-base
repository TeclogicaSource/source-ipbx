...
$mode=SEARCH_SIMPLE;
$templatefile = "Rel__Historico_Fila_Data_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Rel__Historico_Fila_Data_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Rel__Historico_Fila_Data';
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Rel__Historico_Fila_Data_report.php\" ";
	}
