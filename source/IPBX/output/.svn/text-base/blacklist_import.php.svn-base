...
// keys array
$keys[]=AddFieldWrappers("id_bl_list");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"blacklist_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='blacklist_list.php?a=return';\"");
...
$xt->display("blacklist_import.htm");
