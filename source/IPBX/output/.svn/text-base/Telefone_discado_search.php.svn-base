...
include("include/Telefone_discado_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Telefone_discado_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Telefone_discado_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Telefone_discado';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Telefones Discados";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Telefone_discado_report.php\" ";
	}
