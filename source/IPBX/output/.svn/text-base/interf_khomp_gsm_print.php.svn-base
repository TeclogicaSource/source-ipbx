...
//	id_k_gsm - 
			$value="";
				$value = ProcessLargeText(GetData($data,"id_k_gsm", ""),"field=id%5Fk%5Fgsm".$keylink,"",MODE_PRINT);
			$record["id_k_gsm_value"]=$value;
...
//	include proper masterprint.php code
	...
	$params=array("detailtable"=>"interf_khomp_gsm","keys"=>$masterkeys);
	$master=array();
...
$xt->assign("id_k_gsm_fieldheadercolumn",true);
$xt->assign("id_k_gsm_fieldheader",true);
$xt->assign("id_k_gsm_fieldcolumn",true);
$xt->assign("id_k_gsm_fieldfootercolumn",true);
...
$xt->assign("link_fieldheadercolumn",true);
$xt->assign("link_fieldheader",true);
$xt->assign("link_fieldcolumn",true);
$xt->assign("link_fieldfootercolumn",true);
...
$templatefile = "interf_khomp_gsm_print.htm";
