...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Graf_per__temp_espera_por_dia",
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Graf_per__temp_espera_por_dia_search.php';return false;\"");
$xt->assign("search_records_block",true);
//$xt->assign("recordcontrols_block",true);

$xt->assign("searchform_showall",true);
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Graf_per__temp_espera_por_dia_chart.php?a=showall';\"");

if(!GetChartXML("Graf_per__temp_espera_por_dia"))
...
$templatefile = "Graf_per__temp_espera_por_dia_chart.htm";
