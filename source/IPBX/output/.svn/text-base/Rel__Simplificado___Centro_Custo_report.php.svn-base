...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Rel__Simplificado___Centro_Custo",
...
$params['shortTName'] = "Rel__Simplificado___Centro_Custo";
...
$groupField = array();
$groupField['strGroupField'] = "dsc_interf";
...
$fieldArr = array();
$fieldArr['name'] = "DataHora";
$fieldArr['goodName'] = "DataHora";
$fieldArr['repPage'] = "0";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Rel__Simplificado___Centro_Custo_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Rel__Simplificado___Centro_Custo_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Rel__Simplificado___Centro_Custo_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Rel__Simplificado___Centro_Custo_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Rel__Simplificado___Centro_Custo_report.htm";
