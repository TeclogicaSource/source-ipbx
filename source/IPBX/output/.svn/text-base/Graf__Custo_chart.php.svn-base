...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Graf__Custo_search.php';return false;\"");
$xt->assign("search_records_block",true);
//$xt->assign("recordcontrols_block",true);

$xt->assign("searchform_showall",true);
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Graf__Custo_chart.php?a=showall';\"");

if(!GetChartXML("Graf__Custo"))
...
$templatefile = "Graf__Custo_chart.htm";
