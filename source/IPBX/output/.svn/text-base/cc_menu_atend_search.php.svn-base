...
$mode=SEARCH_SIMPLE;
$templatefile = "cc_menu_atend_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "cc_menu_atend_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'cc_menu_atend';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "cc_menu_atend";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("dsc_menu");
	...
	{
		$firstFieldParams['fName'] = "dsc_menu";
	...
	$xt->assignbyref("dsc_menu_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("dsc_menu_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("dsc_menu_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_dsc_menu", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("dsc_menu", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("dsc_menu")."', ".$pageObject->id.", ".$ctrlsMap.");";
	...
	{
	$contents_block["begin"].="action=\"cc_menu_atend_list.php\" ";
	}
