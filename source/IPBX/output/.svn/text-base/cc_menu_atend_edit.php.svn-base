...
if($readevalues)
{
	...
	$data["id_fluxo"]=$evalues["id_fluxo"];
}
/////////////////////////////////////////////////////////////
...
$control_id_fluxo["params"]["value"]=@$data["id_fluxo"];
//	Begin Add validation
$arrValidate = array();	
...
$additionalCtrlParams = array();
$additionalCtrlParams["disabled"] = !$enableCtrlsForEditing;
$control_id_fluxo["params"]["additionalCtrlParams"]=$additionalCtrlParams;
if($inlineedit)
	$control_id_fluxo["params"]["mode"]="inline_edit";
else
	$control_id_fluxo["params"]["mode"]="edit";
if(!$detailKeys || !in_array("id_fluxo", $detailKeys))	
	$xt->assign("id_fluxo_editcontrol",$control_id_fluxo);
else if(array_key_exists("id_fluxo",$data))
{
				$value=DisplayLookupWizard("id_fluxo",$data["id_fluxo"],$data,"",MODE_VIEW);
