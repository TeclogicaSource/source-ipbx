...
$xt->assign("Agent_Disp_fieldheader",true);
$xt->assign("AgentesPausa_fieldheader",true);
$xt->assign("Chamadas_Atendidas_fieldheader",true);
$xt->assign("Chamadas_Abandonadas_fieldheader",true);
...
$templatefile = "Rel__Historico_Fila_print.htm";
