...
include("include/interf_ms_lync_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "interf_ms_lync_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "interf_ms_lync_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'interf_ms_lync';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "interf_ms_lync";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("id_ms_lync");
	...
	{
		$firstFieldParams['fName'] = "id_ms_lync";
	...
	if(isEnableSection508())
		$xt->assign_section("id_ms_lync_label","<label for=\"".GetInputElementId("id_ms_lync", $id)."\">","</label>");
	else 
		$xt->assign("id_ms_lync_label", true);
	
	$xt->assign("id_ms_lync_fieldblock", true);		
	$xt->assignbyref("id_ms_lync_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("id_ms_lync_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("id_ms_lync_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_id_ms_lync", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("id_ms_lync", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("id_ms_lync")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	...
	{
	$contents_block["begin"].="action=\"interf_ms_lync_list.php\" ";
	}
