...
if (@$_REQUEST["format"]=="excel")
{
	...
	header("Content-Disposition: attachment;Filename=Rel_Chamada_Detalhada.xls");
...
else if (@$_REQUEST["format"]=="word")
{
	...
	header("Content-Disposition: attachment;Filename=Rel_Chamada_Detalhada.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("Entrada_Saida_fieldheader",true);
$xt->assign("Terminado_fieldheader",true);
...
$xt->assign("Obs__fieldheader",true);
...
$templatefile = "Rel_Chamada_Detalhada_print.htm";
