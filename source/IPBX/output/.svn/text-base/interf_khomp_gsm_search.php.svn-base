...
$mode=SEARCH_SIMPLE;
$templatefile = "interf_khomp_gsm_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "interf_khomp_gsm_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'interf_khomp_gsm';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "interf_khomp_gsm";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("id_k_gsm");
	...
	{
		$firstFieldParams['fName'] = "id_k_gsm";
	...
	if(isEnableSection508())
		$xt->assign_section("id_k_gsm_label","<label for=\"".GetInputElementId("id_k_gsm", $id)."\">","</label>");
	else 
		$xt->assign("id_k_gsm_label", true);
	
	$xt->assign("id_k_gsm_fieldblock", true);		
	$xt->assignbyref("id_k_gsm_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("id_k_gsm_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("id_k_gsm_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_id_k_gsm", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("id_k_gsm", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("id_k_gsm")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	...
	{
	$contents_block["begin"].="action=\"interf_khomp_gsm_list.php\" ";
	}
