...
if ( $rowcount ) {
	...
	//	qtd_cham_por_ramal - 
		    $value="";
				$value = ProcessLargeText(GetData($data,"qtd_cham_por_ramal", ""),"field=qtd%5Fcham%5Fpor%5Framal".$keylink,"",MODE_PRINT);
			$row["qtd_cham_por_ramal_value"]=$value;
	$rowinfo[]=$row;
	}
	$xt->assign_loopsection("details_row",$rowinfo);
} else {
}
$xt->display("ipbx_interf_voxip_detailspreview.htm");
if($mode!="inline")
