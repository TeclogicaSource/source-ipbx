...
$mode=SEARCH_SIMPLE;
$templatefile = "centrocusto_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "centrocusto_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'centrocusto';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "centrocusto";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"centrocusto_list.php\" ";
	}
