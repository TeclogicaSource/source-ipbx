...
$pageObject->body["begin"] .="<form action=\"Rel__Produt_Agentes_Dia_export.php\" method=POST id=frmexport name=frmexport>";
$pageObject->body["end"] .= "</form><script>".$pageObject->PrepareJS()."</script>";
$xt->assignbyref("body",$pageObject->body);

$xt->display("Rel__Produt_Agentes_Dia_export.htm");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Produt_Agentes_Dia.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Produt_Agentes_Dia.csv");
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Total Atendendo").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Média Atendimento").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Total pausa Obrigatória").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Total pausa Produtiva").'</td>';	
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Recebida").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Contribuição Individual").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Contribuição Total").'</td>';	
	}
	else
	{
		echo "<td>"."Data"."</td>";
