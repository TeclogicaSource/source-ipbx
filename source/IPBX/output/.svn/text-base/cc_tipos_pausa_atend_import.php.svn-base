...
// keys array
$keys[]=AddFieldWrappers("idt_pausa_atend");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"cc_tipos_pausa_atend_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='cc_tipos_pausa_atend_list.php?a=return';\"");
...
$xt->display("cc_tipos_pausa_atend_import.htm");
