...
$mode=SEARCH_SIMPLE;
$templatefile = "Rel__Simplificado___Centro_Custo_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Rel__Simplificado___Centro_Custo_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Rel__Simplificado___Centro_Custo';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Simplificado - Centro Custo";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Rel__Simplificado___Centro_Custo_report.php\" ";
	}
