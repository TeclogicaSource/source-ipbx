...
$mode=SEARCH_SIMPLE;
$templatefile = "ipbx_fila_pesquisa_ura_rev_resp_Report_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "ipbx_fila_pesquisa_ura_rev_resp_Report_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'ipbx_fila_pesquisa_ura_rev_resp_Report';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Pesquisa Reversa";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("dsc_pesquisa");
	...
	{
		$firstFieldParams['fName'] = "dsc_pesquisa";
	...
	if(isEnableSection508())
		$xt->assign_section("dsc_pesquisa_label","<label for=\"".GetInputElementId("dsc_pesquisa", $id)."\">","</label>");
	else 
		$xt->assign("dsc_pesquisa_label", true);
	
	$xt->assign("dsc_pesquisa_fieldblock", true);		
	$xt->assignbyref("dsc_pesquisa_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("dsc_pesquisa_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("dsc_pesquisa_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_dsc_pesquisa", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("dsc_pesquisa", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("dsc_pesquisa")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("dsc_mensagem");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "dsc_mensagem";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	$xt->assignbyref("dsc_mensagem_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("dsc_mensagem_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("dsc_mensagem_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_dsc_mensagem", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("dsc_mensagem", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("dsc_mensagem")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("txt_resp");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "txt_resp";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("txt_resp_label","<label for=\"".GetInputElementId("txt_resp", $id)."\">","</label>");
	else 
		$xt->assign("txt_resp_label", true);
	
	$xt->assign("txt_resp_fieldblock", true);		
	$xt->assignbyref("txt_resp_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("txt_resp_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("txt_resp_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_txt_resp", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("txt_resp", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("txt_resp")."', ".$pageObject->id.", ".$ctrlsMap.");";
	...
	{
	$contents_block["begin"].="action=\"ipbx_fila_pesquisa_ura_rev_resp_Report_report.php\" ";
	}
