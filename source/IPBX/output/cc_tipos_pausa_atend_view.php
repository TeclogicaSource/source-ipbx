...
$fieldsArr = array();
$arr = array();
$arr['fName'] = "idt_pausa_atend";
$arr['viewFormat'] = ViewFormat("idt_pausa_atend", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "dt_acao_pausa";
$arr['viewFormat'] = ViewFormat("dt_acao_pausa", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "hr_acao_pausa";
$arr['viewFormat'] = ViewFormat("hr_acao_pausa", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "tp_pausa";
$arr['viewFormat'] = ViewFormat("tp_pausa", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Agente";
$arr['viewFormat'] = ViewFormat("Agente", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "name";
...
$arr = array();
$arr['fName'] = "Fila";
$arr['viewFormat'] = ViewFormat("Fila", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "tipo_pausa";
$arr['viewFormat'] = ViewFormat("tipo_pausa", $strTableName);
$fieldsArr[] = $arr;
...
//idt_pausa_atend - 
	$value="";
	$value = ProcessLargeText(GetData($data,"idt_pausa_atend", ""),"","",MODE_VIEW);
	$xt->assign("idt_pausa_atend_value",$value);
	$xt->assign("idt_pausa_atend_fieldblock",true);
////////////////////////////////////////////
//dt_acao_pausa - Short Date
	$value="";
	$value = ProcessLargeText(GetData($data,"dt_acao_pausa", "Short Date"),"","",MODE_VIEW);
	$xt->assign("dt_acao_pausa_value",$value);
	$xt->assign("dt_acao_pausa_fieldblock",true);
////////////////////////////////////////////
//hr_acao_pausa - Time
	$value="";
	$value = ProcessLargeText(GetData($data,"hr_acao_pausa", "Time"),"","",MODE_VIEW);
	$xt->assign("hr_acao_pausa_value",$value);
	$xt->assign("hr_acao_pausa_fieldblock",true);
////////////////////////////////////////////
//tp_pausa - Time
	$value="";
	$value = ProcessLargeText(GetData($data,"tp_pausa", "Time"),"","",MODE_VIEW);
	$xt->assign("tp_pausa_value",$value);
	$xt->assign("tp_pausa_fieldblock",true);
////////////////////////////////////////////
//Agente - 
	$value="";
	$value = ProcessLargeText(GetData($data,"Agente", ""),"","",MODE_VIEW);
	$xt->assign("Agente_value",$value);
...
//Fila - 
	$value="";
	$value = ProcessLargeText(GetData($data,"Fila", ""),"","",MODE_VIEW);
	$xt->assign("Fila_value",$value);
	$xt->assign("Fila_fieldblock",true);
////////////////////////////////////////////
//tipo_pausa - 
	$value="";
	$value = ProcessLargeText(GetData($data,"tipo_pausa", ""),"","",MODE_VIEW);
	$xt->assign("tipo_pausa_value",$value);
	$xt->assign("tipo_pausa_fieldblock",true);
 


$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("idt_pausa_atend")."': '".(jsreplace(@$data["idt_pausa_atend"]))."', ";
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='cc_tipos_pausa_atend_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='cc_tipos_pausa_atend_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "cc_tipos_pausa_atend_view.htm";
