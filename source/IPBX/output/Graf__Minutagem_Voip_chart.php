...
include("include/Graf__Minutagem_Voip_variables.php");
...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Graf__Minutagem_Voip",
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Graf__Minutagem_Voip_search.php';return false;\"");
$xt->assign("search_records_block",true);
//$xt->assign("recordcontrols_block",true);

$xt->assign("searchform_showall",true);
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Graf__Minutagem_Voip_chart.php?a=showall';\"");

if(!GetChartXML("Graf__Minutagem_Voip"))
...
$templatefile = "Graf__Minutagem_Voip_chart.htm";
