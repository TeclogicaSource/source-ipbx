...
$fieldsArr = array();
$arr = array();
$arr['fName'] = "id_interf_vono";
$arr['viewFormat'] = ViewFormat("id_interf_vono", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
...
//id_interf_vono - 
	$value="";
	$value = ProcessLargeText(GetData($data,"id_interf_vono", ""),"","",MODE_VIEW);
	$xt->assign("id_interf_vono_value",$value);
...
$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("id_interf_vono")."': '".(jsreplace(@$data["id_interf_vono"]))."', ";
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='interf_vono_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='interf_vono_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "interf_vono_view.htm";
