...
$mode=SEARCH_SIMPLE;
$templatefile = "Rel_Produtividade_da_Fila_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Rel_Produtividade_da_Fila_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Rel_Produtividade_da_Fila';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel Produtividade da Fila";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Rel_Produtividade_da_Fila_report.php\" ";
	}
