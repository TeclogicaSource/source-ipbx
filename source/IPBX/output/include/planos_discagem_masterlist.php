...
//	id_plano - 
			$value="";
				$value = ProcessLargeText(GetData($data,"id_plano", ""),"field=id%5Fplano".$keylink);
			$xt->assign("id_plano_mastervalue",$value);

//	DDD - 
			$value="";
				$value = ProcessLargeText(GetData($data,"DDD", ""),"field=DDD".$keylink);
...
//	id_tronco - 
	...
	$strTableName=$oldTableName;
	$xt->display("planos_discagem_masterlist.htm");
}
