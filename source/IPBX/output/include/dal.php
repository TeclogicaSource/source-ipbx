...
class tDAL
{
	...
	var $log_fila_agente_consolidada;
	var $v_graf_perf_temp_atendimento;
	var $v_produt_filas_grupo_data;
	var $v_produt_filas_grupo_mes;
	var $v_rel_produt_agente_dia;
	var $v_rel_prod_agentes_dia;
	var $v_rel_disp_agente;
	var $ipbx_provisionamento;
	var $blacklist;
	var $ipbx_ugmembers;
	var $estrategia_fila;
	...
	function FillTablesList()
	{
	  ...
	  $this->lstTables[]=array("name"=>"log_fila_agente_consolidada","varname"=>"log_fila_agente_consolidada");
	  ...
	  $this->lstTables[]=array("name"=>"v_rel_produt_agente_dia","varname"=>"v_rel_produt_agente_dia");
	  $this->lstTables[]=array("name"=>"v_rel_prod_agentes_dia","varname"=>"v_rel_prod_agentes_dia");
	  $this->lstTables[]=array("name"=>"v_rel_disp_agente","varname"=>"v_rel_disp_agente");
	  $this->lstTables[]=array("name"=>"ipbx_provisionamento","varname"=>"ipbx_provisionamento");
	  $this->lstTables[]=array("name"=>"blacklist","varname"=>"blacklist");
	  ...
	  $this->lstTables[]=array("name"=>"ipbx_fluxograma","varname"=>"ipbx_fluxograma");
	  $this->lstTables[]=array("name"=>"ipbx_lang","varname"=>"ipbx_lang");
