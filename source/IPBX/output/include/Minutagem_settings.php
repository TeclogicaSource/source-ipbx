...
$proto324["m_strFieldList"] = "DATE_FORMAT(ct.calldate,'%m-%Y') AS `DATA`,  round(sum(ct.custo)) AS custo,  round(sum(ct.duracao/60)) AS Minutos,  DATE_FORMAT(ct.calldate,'%Y') AS `DATE_FORMAT(conta.calldate,'%Y')`,  DATE_FORMAT(ct.calldate,'%m') AS `DATE_FORMAT(conta.calldate,'%m')`";
$proto324["m_strFrom"] = "FROM conta ct, ipbx_interf ii";
$proto324["m_strWhere"] = "ct.id_interf = ii.id_interf and  ii.id_tp_interf in (2,4,8)";
$proto324["m_strOrderBy"] = "ORDER BY DATE_FORMAT(ct.calldate,'%Y') desc, DATE_FORMAT(ct.calldate,'%m') desc";
$proto324["m_strTail"] = "GROUP BY DATE_FORMAT(ct.calldate,'%m-%Y')";
$proto325=array();
$proto325["m_sql"] = "ct.id_interf = ii.id_interf and  ii.id_tp_interf in (2,4,8)";
$proto325["m_uniontype"] = "SQLL_AND";
...
$proto325["m_contained"] = array();
						$proto327=array();
$proto327["m_sql"] = "ct.id_interf = ii.id_interf";
...
$proto327["m_strCase"] = "= ii.id_interf";
$proto327["m_havingmode"] = "0";
$proto327["m_inBrackets"] = "0";
$proto327["m_useAlias"] = "0";
$obj = new SQLLogicalExpr($proto327);

			$proto325["m_contained"][]=$obj;
						$proto329=array();
$proto329["m_sql"] = "ii.id_tp_interf in (2,4,8)";
...
$proto329["m_strCase"] = "in (2,4,8)";
$proto329["m_havingmode"] = "0";
$proto329["m_inBrackets"] = "0";
$proto329["m_useAlias"] = "0";
$obj = new SQLLogicalExpr($proto329);

			$proto325["m_contained"][]=$obj;
$proto325["m_strCase"] = "";
$proto325["m_havingmode"] = "0";
$proto325["m_inBrackets"] = "0";
$proto325["m_useAlias"] = "0";
...
$proto331["m_strCase"] = "";
$proto331["m_havingmode"] = "0";
$proto331["m_inBrackets"] = "0";
$proto331["m_useAlias"] = "0";
...
$proto333["m_expr"]=$obj;
$proto333["m_alias"] = "DATA";
$obj = new SQLFieldListItem($proto333);
...
$proto336["m_strFunctionName"] = "round";
$obj = new SQLFunctionCall($proto336);

$proto335["m_expr"]=$obj;
$proto335["m_alias"] = "custo";
$obj = new SQLFieldListItem($proto335);

$proto324["m_fieldlist"][]=$obj;
						$proto338=array();
			$proto339=array();
$proto339["m_functiontype"] = "SQLF_CUSTOM";
...
$proto339["m_strFunctionName"] = "round";
$obj = new SQLFunctionCall($proto339);

$proto338["m_expr"]=$obj;
$proto338["m_alias"] = "Minutos";
...
$proto341["m_expr"]=$obj;
$proto341["m_alias"] = "DATE_FORMAT(conta.calldate,'%Y')";
...
$proto343["m_expr"]=$obj;
$proto343["m_alias"] = "DATE_FORMAT(conta.calldate,'%m')";
...
$proto345["m_link"] = "SQLL_MAIN";
			$proto346=array();
$proto346["m_strName"] = "conta";
$proto346["m_columns"] = array();
$proto346["m_columns"][] = "id_conta";
$proto346["m_columns"][] = "idt_custo";
$proto346["m_columns"][] = "origem";
$proto346["m_columns"][] = "destino";
$proto346["m_columns"][] = "duracao";
$proto346["m_columns"][] = "custo";
$proto346["m_columns"][] = "calldate";
$proto346["m_columns"][] = "uniqueid";
$proto346["m_columns"][] = "id_interf";
$proto346["m_columns"][] = "id_contrato";
$proto346["m_columns"][] = "mes_referencia";
$proto346["m_columns"][] = "ano_referencia";
...
$proto347["m_strCase"] = "";
$proto347["m_havingmode"] = "0";
$proto347["m_inBrackets"] = "0";
$proto347["m_useAlias"] = "0";
...
$proto324["m_fromlist"][]=$obj;
												$proto349=array();
$proto349["m_link"] = "SQLL_CROSSJOIN";
			$proto350=array();
$proto350["m_strName"] = "ipbx_interf";
$proto350["m_columns"] = array();
$proto350["m_columns"][] = "id_interf";
$proto350["m_columns"][] = "dsc_interf";
$proto350["m_columns"][] = "id_contrato";
$proto350["m_columns"][] = "board";
$proto350["m_columns"][] = "link";
$proto350["m_columns"][] = "usuario";
$proto350["m_columns"][] = "senha";
$proto350["m_columns"][] = "ip_host";
$proto350["m_columns"][] = "id_central";
$proto350["m_columns"][] = "codec";
$proto350["m_columns"][] = "id_tp_interf";
$proto350["m_columns"][] = "tp_chamada";
$proto350["m_columns"][] = "piloto";
$proto350["m_columns"][] = "id_chamada";
$proto350["m_columns"][] = "flg_id_cham_parc";
$proto350["m_columns"][] = "dtmf";
$proto350["m_columns"][] = "ddd_localidade";
$proto350["m_columns"][] = "cd_operadora";
$proto350["m_columns"][] = "khomp_interf";
$proto350["m_columns"][] = "flg_logon_remoto";
$proto350["m_columns"][] = "pers_params";
$proto350["m_columns"][] = "registro";
$proto350["m_columns"][] = "qtd_cham_por_ramal";
...
$proto351["m_strCase"] = "";
$proto351["m_havingmode"] = "0";
$proto351["m_inBrackets"] = "0";
$proto351["m_useAlias"] = "0";
...
$obj = new SQLGroupByItem($proto353);

$proto324["m_groupby"][]=$obj;
...
$proto355["m_bAsc"] = 0;
$proto355["m_nColumn"] = 0;
$obj = new SQLOrderByItem($proto355);

$proto324["m_orderby"][]=$obj;					
												$proto357=array();
						$obj = new SQLNonParsed(array(
	"m_sql" => "DATE_FORMAT(ct.calldate,'%m') "
));
...
$proto357["m_bAsc"] = 0;
$proto357["m_nColumn"] = 0;
$obj = new SQLOrderByItem($proto357);
