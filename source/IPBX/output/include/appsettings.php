...
$tableCaptions["Portuguese(Brazil)"]["Rel__Produt__Agentes_Dia"] = "Produt. Agentes Dia";
$tableCaptions["Portuguese(Brazil)"]["Rel__Disponibilidade_Agente"] = "Rel. Disponibilidade Agente";
$tableCaptions["Portuguese(Brazil)"]["ipbx_provisionamento"] = "Provisionamento";
$tableCaptions["Portuguese(Brazil)"]["blacklist"] = "Bloqueio de telefones indesejados (blacklist)";
$tableCaptions["Portuguese(Brazil)"]["Rel__Desvios_Chamadas"] = "Rel. Desvios Chamadas";
$tableCaptions["Portuguese(Brazil)"]["ipbx_ugmembers"] = "Ipbx Ugmembers";
...
$menuTablesArr[] = array("shortTName"=>"ipbx_provisionamento","dataSourceTName"=>"ipbx_provisionamento","nType"=>0);
...
$menuTablesArr[] = array("shortTName"=>"blacklist","dataSourceTName"=>"blacklist","nType"=>0);
...
$menuTablesArr[] = array("shortTName"=>"Rel__Desvios_Chamadas","dataSourceTName"=>"Rel. Desvios Chamadas","nType"=>2);
...
$menuTablesArr[] = array("shortTName"=>"Rel__Disponibilidade_Agente","dataSourceTName"=>"Rel. Disponibilidade Agente","nType"=>2);
...
$menuTablesArr[] = array("shortTName"=>"Rel__Produt_Agentes_Dia","dataSourceTName"=>"Rel. Produt. Agentes Dia","nType"=>2);
...
$menuTablesArr[] = array("shortTName"=>"ipbx_ugmembers","dataSourceTName"=>"ipbx_ugmembers","nType"=>0);
