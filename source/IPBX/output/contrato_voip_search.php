...
$mode=SEARCH_SIMPLE;
$templatefile = "contrato_voip_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "contrato_voip_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'contrato_voip';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "contrato_voip";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"contrato_voip_list.php\" ";
	}
