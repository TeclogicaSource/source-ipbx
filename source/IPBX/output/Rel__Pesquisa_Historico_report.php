...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Rel__Pesquisa_Historico",
...
$params['shortTName'] = "Rel__Pesquisa_Historico";
...
$fieldArr = array();
$fieldArr['name'] = "id_resp_pesq";
$fieldArr['goodName'] = "id_resp_pesq";
$fieldArr['repPage'] = "0";
$fieldArr['viewFormat'] = "";
...
$fieldArr = array();
$fieldArr['name'] = "dsc_pesquisa";
$fieldArr['goodName'] = "dsc_pesquisa";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "dt_resp";
$fieldArr['goodName'] = "dt_resp";
$fieldArr['repPage'] = "1";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "nm_ramal";
$fieldArr['goodName'] = "nm_ramal";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "usuario";
$fieldArr['goodName'] = "usuario";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "nr_ordem";
$fieldArr['goodName'] = "nr_ordem";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "nm_telefone";
$fieldArr['goodName'] = "nm_telefone";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "dsc_mensagem";
$fieldArr['goodName'] = "dsc_mensagem";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "txt_resp";
$fieldArr['goodName'] = "txt_resp";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "id_pesquisa";
$fieldArr['goodName'] = "id_pesquisa";
$fieldArr['repPage'] = "0";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Rel__Pesquisa_Historico_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Rel__Pesquisa_Historico_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Rel__Pesquisa_Historico_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Rel__Pesquisa_Historico_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Rel__Pesquisa_Historico_report.htm";
