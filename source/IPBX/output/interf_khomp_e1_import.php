...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"interf_khomp_e1_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='interf_khomp_e1_list.php?a=return';\"");
...
$xt->display("interf_khomp_e1_import.htm");
