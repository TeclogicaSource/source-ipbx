...
include("include/Graf__Custo_GSM_variables.php");
...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Graf__Custo_GSM",
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Graf__Custo_GSM_search.php';return false;\"");
$xt->assign("search_records_block",true);
//$xt->assign("recordcontrols_block",true);

$xt->assign("searchform_showall",true);
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Graf__Custo_GSM_chart.php?a=showall';\"");

if(!GetChartXML("Graf__Custo_GSM"))
...
$templatefile = "Graf__Custo_GSM_chart.htm";
