...
$mode=SEARCH_SIMPLE;
$templatefile = "Lig__Discadas_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Lig__Discadas_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Lig__Discadas';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Lig. Discadas";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Lig__Discadas_report.php\" ";
	}
