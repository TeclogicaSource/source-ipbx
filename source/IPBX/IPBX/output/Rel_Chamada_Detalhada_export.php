...
$pageObject->body["begin"] .="<form action=\"Rel_Chamada_Detalhada_export.php\" method=POST id=frmexport name=frmexport>";
$pageObject->body["end"] .= "</form><script>".$pageObject->PrepareJS()."</script>";
$xt->assignbyref("body",$pageObject->body);

$xt->display("Rel_Chamada_Detalhada_export.htm");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=Rel_Chamada_Detalhada.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=Rel_Chamada_Detalhada.csv");
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Observação").'</td>';	
	}
	else
	{
		echo "<td>"."Fila"."</td>";
