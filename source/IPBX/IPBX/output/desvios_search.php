...
$mode=SEARCH_SIMPLE;
$templatefile = "desvios_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "desvios_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'desvios';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "desvios";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"desvios_list.php\" ";
	}
