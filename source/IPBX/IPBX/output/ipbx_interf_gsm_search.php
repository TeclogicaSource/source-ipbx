...
$mode=SEARCH_SIMPLE;
$templatefile = "ipbx_interf_gsm_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "ipbx_interf_gsm_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'ipbx_interf_gsm';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "ipbx_interf_gsm";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"ipbx_interf_gsm_list.php\" ";
	}
