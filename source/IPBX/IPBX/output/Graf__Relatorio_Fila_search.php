...
include("include/Graf__Relatorio_Fila_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Graf__Relatorio_Fila_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Graf__Relatorio_Fila_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Graf__Relatorio_Fila';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Graf. Relatorio Fila";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Graf__Relatorio_Fila_chart.php\" ";
	}
