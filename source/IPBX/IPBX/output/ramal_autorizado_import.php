...
// keys array
$keys[]=AddFieldWrappers("id_ramal");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"ramal_autorizado_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='ramal_autorizado_list.php?a=return';\"");
...
$xt->display("ramal_autorizado_import.htm");
