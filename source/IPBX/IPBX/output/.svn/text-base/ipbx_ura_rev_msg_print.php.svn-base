...
//	id_ipbx_ura_rev_msg - 
			$value="";
				$value = ProcessLargeText(GetData($data,"id_ipbx_ura_rev_msg", ""),"field=id%5Fipbx%5Fura%5Frev%5Fmsg".$keylink,"",MODE_PRINT);
			$record["id_ipbx_ura_rev_msg_value"]=$value;

//	arq_audio - Document Download
			$value="";
				$value = GetData($data,"arq_audio", "Document Download");
			$record["arq_audio_value"]=$value;
			if($col<$colsonpage)
...
$xt->assign("id_ipbx_ura_rev_msg_fieldheadercolumn",true);
$xt->assign("id_ipbx_ura_rev_msg_fieldheader",true);
$xt->assign("id_ipbx_ura_rev_msg_fieldcolumn",true);
$xt->assign("id_ipbx_ura_rev_msg_fieldfootercolumn",true);
$xt->assign("arq_audio_fieldheadercolumn",true);
$xt->assign("arq_audio_fieldheader",true);
$xt->assign("arq_audio_fieldcolumn",true);
$xt->assign("arq_audio_fieldfootercolumn",true);
...
$templatefile = "ipbx_ura_rev_msg_print.htm";
