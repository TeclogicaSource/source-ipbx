...
$pageObject->body["begin"] .="<form action=\"centrocusto_export.php\" method=POST id=frmexport name=frmexport>";
$pageObject->body["end"] .= "</form><script>".$pageObject->PrepareJS()."</script>";
$xt->assignbyref("body",$pageObject->body);

$xt->display("centrocusto_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=centrocusto.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=centrocusto.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=centrocusto.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=centrocusto.csv");
