...
$fieldsArr = array();
$arr = array();
$arr['fName'] = "id_ipbx_ura_rev_msg";
$arr['viewFormat'] = ViewFormat("id_ipbx_ura_rev_msg", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "arq_audio";
$arr['viewFormat'] = ViewFormat("arq_audio", $strTableName);
$fieldsArr[] = $arr;
...
//id_ipbx_ura_rev_msg - 
	$value="";
	$value = ProcessLargeText(GetData($data,"id_ipbx_ura_rev_msg", ""),"","",MODE_VIEW);
	$xt->assign("id_ipbx_ura_rev_msg_value",$value);
	$xt->assign("id_ipbx_ura_rev_msg_fieldblock",true);
////////////////////////////////////////////
//arq_audio - Document Download
	$value="";
	$value = GetData($data,"arq_audio", "Document Download");
	$xt->assign("arq_audio_value",$value);
	$xt->assign("arq_audio_fieldblock",true);
 


$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("id_ipbx_ura_rev_msg")."': '".(jsreplace(@$data["id_ipbx_ura_rev_msg"]))."', ";
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='ipbx_ura_rev_msg_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='ipbx_ura_rev_msg_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "ipbx_ura_rev_msg_view.htm";
