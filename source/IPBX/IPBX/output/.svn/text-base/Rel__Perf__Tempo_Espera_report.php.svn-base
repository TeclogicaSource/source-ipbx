...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Rel__Perf__Tempo_Espera",
...
$params['shortTName'] = "Rel__Perf__Tempo_Espera";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "Tempo em faixas";
$fieldArr['goodName'] = "Tempo_em_faixas";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "Quantidade";
$fieldArr['goodName'] = "Quantidade";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Rel__Perf__Tempo_Espera_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Rel__Perf__Tempo_Espera_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Rel__Perf__Tempo_Espera_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Rel__Perf__Tempo_Espera_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Rel__Perf__Tempo_Espera_report.htm";
