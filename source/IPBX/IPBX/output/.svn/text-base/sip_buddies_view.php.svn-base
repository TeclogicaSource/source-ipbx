...
$arr = array();
$arr['fName'] = "callerid";
$arr['viewFormat'] = ViewFormat("callerid", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "name";
...
$arr = array();
$arr['fName'] = "context";
$arr['viewFormat'] = ViewFormat("context", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "mailbox";
$arr['viewFormat'] = ViewFormat("mailbox", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "secret";
$arr['viewFormat'] = ViewFormat("secret", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "allow";
$arr['viewFormat'] = ViewFormat("allow", $strTableName);
$fieldsArr[] = $arr;
...
//callerid - 
	$value="";
	$value = ProcessLargeText(GetData($data,"callerid", ""),"","",MODE_VIEW);
	$xt->assign("callerid_value",$value);
	$xt->assign("callerid_fieldblock",true);
////////////////////////////////////////////
//name - HTML
	$value="";
	$value = GetData($data,"name", "HTML");
	$xt->assign("name_value",$value);
	$xt->assign("name_fieldblock",true);
////////////////////////////////////////////
//accountcode - 
	$value="";
	$value=DisplayLookupWizard("accountcode",$data["accountcode"],$data,$keylink,MODE_VIEW);
	$xt->assign("accountcode_value",$value);
	$xt->assign("accountcode_fieldblock",true);
////////////////////////////////////////////
//context - 
	$value="";
	$value = ProcessLargeText(GetData($data,"context", ""),"","",MODE_VIEW);
	$xt->assign("context_value",$value);
	$xt->assign("context_fieldblock",true);
////////////////////////////////////////////
//mailbox - 
	$value="";
	$value = ProcessLargeText(GetData($data,"mailbox", ""),"","",MODE_VIEW);
	$xt->assign("mailbox_value",$value);
	$xt->assign("mailbox_fieldblock",true);
////////////////////////////////////////////
//secret - 
	$value="";
	$value = ProcessLargeText(GetData($data,"secret", ""),"","",MODE_VIEW);
	$xt->assign("secret_value",$value);
	$xt->assign("secret_fieldblock",true);
////////////////////////////////////////////
//allow - 
	$value="";
	$value=DisplayLookupWizard("allow",$data["allow"],$data,$keylink,MODE_VIEW);
	$xt->assign("allow_value",$value);
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='sip_buddies_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='sip_buddies_view.php?".$prevlink."'\"");
	}
    else 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$xt->assign("backbutton_attrs","onclick=\"window.location.href='sip_buddies_list.php?a=return'\"");
}

$oldtemplatefile=$templatefile;
$templatefile = "sip_buddies_view.htm";
