...
// keys array
$keys[]=AddFieldWrappers("id_conf_fax");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"ipbx_conf_fax_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='ipbx_conf_fax_list.php?a=return';\"");
...
$xt->display("ipbx_conf_fax_import.htm");
