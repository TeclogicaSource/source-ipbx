...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"VONO_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='VONO_list.php?a=return';\"");
