...
$mode=SEARCH_SIMPLE;
$templatefile = "Rel__Detalhamento_Agente_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Rel__Detalhamento_Agente_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Rel__Detalhamento_Agente';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Detalhamento Agente";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Rel__Detalhamento_Agente_report.php\" ";
	}
