...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Rel_Chamada_Detalhada",
...
$params['shortTName'] = "Rel_Chamada_Detalhada";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Rel_Chamada_Detalhada_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Rel_Chamada_Detalhada_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Rel_Chamada_Detalhada_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Rel_Chamada_Detalhada_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Rel_Chamada_Detalhada_report.htm";
