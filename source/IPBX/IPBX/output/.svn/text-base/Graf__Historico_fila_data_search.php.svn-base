...
include("include/Graf__Historico_fila_data_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Graf__Historico_fila_data_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Graf__Historico_fila_data_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Graf__Historico_fila_data';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Graf. Historico fila data";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Graf__Historico_fila_data_chart.php\" ";
	}
