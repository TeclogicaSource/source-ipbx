...
$mode=SEARCH_SIMPLE;
$templatefile = "sip_users_additional_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "sip_users_additional_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'sip_users_additional';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "sip_users_additional";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("flg_grava");
	...
	{
		$firstFieldParams['fName'] = "flg_grava";
	...
	$xt->assignbyref("flg_grava_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("flg_grava_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("flg_grava_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_flg_grava", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("flg_grava", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("flg_grava")."', ".$pageObject->id.", ".$ctrlsMap.");";
	...
	{
	$contents_block["begin"].="action=\"sip_users_additional_list.php\" ";
	}
