...
$mode=SEARCH_SIMPLE;
$templatefile = "Recebidas_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Recebidas_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Recebidas';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Recebidas";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Recebidas_report.php\" ";
	}
