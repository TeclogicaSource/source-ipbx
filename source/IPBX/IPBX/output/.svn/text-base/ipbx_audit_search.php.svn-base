...
include("include/ipbx_audit_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "ipbx_audit_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "ipbx_audit_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'ipbx_audit';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "ipbx_audit";
...
//--------------------------------------------------------------------------------------	
	...
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("datetime")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	...
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("ip")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	...
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("user")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	...
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("table")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	...
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("action")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	...
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("description")."', ".$pageObject->id.", ".$ctrlsMap.");";
	...
	{
	$contents_block["begin"].="action=\"ipbx_audit_list.php\" ";
	}
