...
$pageObject->body["begin"] .="<form action=\"ipbx_interf_gsm_export.php\" method=POST id=frmexport name=frmexport>";
$pageObject->body["end"] .= "</form><script>".$pageObject->PrepareJS()."</script>";
$xt->assignbyref("body",$pageObject->body);

$xt->display("ipbx_interf_gsm_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=ipbx_interf_gsm.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=ipbx_interf_gsm.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=ipbx_interf_gsm.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=ipbx_interf_gsm.csv");
