...
$fieldsArr = array();
$arr = array();
$arr['fName'] = "id_ramal_horario";
$arr['viewFormat'] = ViewFormat("id_ramal_horario", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "id";
...
//id_ramal_horario - 
	$value="";
	$value = ProcessLargeText(GetData($data,"id_ramal_horario", ""),"","",MODE_VIEW);
	$xt->assign("id_ramal_horario_value",$value);
	$xt->assign("id_ramal_horario_fieldblock",true);
////////////////////////////////////////////
//id - 
	$value="";
...
$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("id_ramal_horario")."': '".(jsreplace(@$data["id_ramal_horario"]))."', ";
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='sip_buddies_horario_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='sip_buddies_horario_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "sip_buddies_horario_view.htm";
