...
$pageObject->body["begin"] .="<form action=\"ipbx_grava_ramal_export.php\" method=POST id=frmexport name=frmexport>";
$pageObject->body["end"] .= "</form><script>".$pageObject->PrepareJS()."</script>";
$xt->assignbyref("body",$pageObject->body);

$xt->display("ipbx_grava_ramal_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=ipbx_grava_ramal.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=ipbx_grava_ramal.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=ipbx_grava_ramal.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=ipbx_grava_ramal.csv");
