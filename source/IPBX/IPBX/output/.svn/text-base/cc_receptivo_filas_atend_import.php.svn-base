...
// keys array
$keys[]=AddFieldWrappers("chave");
$keys[]=AddFieldWrappers("dt_entrada");
$keys[]=AddFieldWrappers("hr_entrada");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"cc_receptivo_filas_atend_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='cc_receptivo_filas_atend_list.php?a=return';\"");
...
$xt->display("cc_receptivo_filas_atend_import.htm");
