...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Graf__perfil_atendimento",
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Graf__perfil_atendimento_search.php';return false;\"");
$xt->assign("search_records_block",true);
//$xt->assign("recordcontrols_block",true);

$xt->assign("searchform_showall",true);
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Graf__perfil_atendimento_chart.php?a=showall';\"");

if(!GetChartXML("Graf__perfil_atendimento"))
...
$templatefile = "Graf__perfil_atendimento_chart.htm";
