...
$mode=SEARCH_SIMPLE;
$templatefile = "ipbx_desv_prefix_item_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "ipbx_desv_prefix_item_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'ipbx_desv_prefix_item';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "ipbx_desv_prefix_item";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("id_desv_pref_item");
	...
	{
		$firstFieldParams['fName'] = "id_desv_pref_item";
	...
	if(isEnableSection508())
		$xt->assign_section("id_desv_pref_item_label","<label for=\"".GetInputElementId("id_desv_pref_item", $id)."\">","</label>");
	else 
		$xt->assign("id_desv_pref_item_label", true);
	
	$xt->assign("id_desv_pref_item_fieldblock", true);		
	$xt->assignbyref("id_desv_pref_item_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("id_desv_pref_item_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("id_desv_pref_item_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_id_desv_pref_item", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("id_desv_pref_item", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("id_desv_pref_item")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("id_desv_prefix");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "id_desv_prefix";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("id_desv_prefix_label","<label for=\"".GetInputElementId("id_desv_prefix", $id)."\">","</label>");
	else 
		$xt->assign("id_desv_prefix_label", true);
	
	$xt->assign("id_desv_prefix_fieldblock", true);		
	$xt->assignbyref("id_desv_prefix_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("id_desv_prefix_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("id_desv_prefix_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_id_desv_prefix", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("id_desv_prefix", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("id_desv_prefix")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("prefixo");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "prefixo";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("prefixo_label","<label for=\"".GetInputElementId("prefixo", $id)."\">","</label>");
	else 
		$xt->assign("prefixo_label", true);
	
	$xt->assign("prefixo_fieldblock", true);		
	$xt->assignbyref("prefixo_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("prefixo_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("prefixo_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_prefixo", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("prefixo", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("prefixo")."', ".$pageObject->id.", ".$ctrlsMap.");";
	...
	{
	$contents_block["begin"].="action=\"ipbx_desv_prefix_item_list.php\" ";
	}
