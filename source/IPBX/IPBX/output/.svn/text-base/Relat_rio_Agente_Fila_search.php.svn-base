...
include("include/Relat_rio_Agente_Fila_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Relat_rio_Agente_Fila_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Relat_rio_Agente_Fila_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Relat_rio_Agente_Fila';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Agente x Fila";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("Data de Entrada");
	...
	{
		$firstFieldParams['fName'] = "Data de Entrada";
	...
	if(isEnableSection508())
		$xt->assign_section("Data_de_Entrada_label","<label for=\"".GetInputElementId("Data de Entrada", $id)."\">","</label>");
	else 
		$xt->assign("Data_de_Entrada_label", true);
	
	$xt->assign("Data_de_Entrada_fieldblock", true);		
	$xt->assignbyref("Data_de_Entrada_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("Data_de_Entrada_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("Data_de_Entrada_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_Data_de_Entrada", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("Data de Entrada", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("Data de Entrada")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("Hora de Entrada");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "Hora de Entrada";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("Hora_de_Entrada_label","<label for=\"".GetInputElementId("Hora de Entrada", $id)."\">","</label>");
	else 
		$xt->assign("Hora_de_Entrada_label", true);
	
	$xt->assign("Hora_de_Entrada_fieldblock", true);		
	$xt->assignbyref("Hora_de_Entrada_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("Hora_de_Entrada_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("Hora_de_Entrada_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_Hora_de_Entrada", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("Hora de Entrada", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("Hora de Entrada")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("Evento");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	if(isEnableSection508())
		$xt->assign_section("Evento_label","<label for=\"".GetInputElementId("Evento", $id)."\">","</label>");
	else 
		$xt->assign("Evento_label", true);
	
	$xt->assign("Evento_fieldblock", true);		
	$xt->assignbyref("Evento_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("Evento_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("Evento_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_Evento", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("Evento", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("Evento")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	...
	{
	$contents_block["begin"].="action=\"Relat_rio_Agente_Fila_report.php\" ";
	}
