...
$strOriginalTableName="`ipbx_disp_mobile`";
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"ipbx_disp_mobile_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='ipbx_disp_mobile_list.php?a=return';\"");
...
$xt->display("ipbx_disp_mobile_import.htm");
