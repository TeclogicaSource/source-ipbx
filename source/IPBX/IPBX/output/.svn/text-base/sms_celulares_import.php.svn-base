...
// keys array
$keys[]=AddFieldWrappers("id_celular");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"sms_celulares_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='sms_celulares_list.php?a=return';\"");
...
$xt->display("sms_celulares_import.htm");
