...
include("include/Hor_rio_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Hor_rio_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Hor_rio_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Hor_rio';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Horarios";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Hor_rio_report.php\" ";
	}
