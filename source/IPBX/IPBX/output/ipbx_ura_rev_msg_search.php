...
$mode=SEARCH_SIMPLE;
$templatefile = "ipbx_ura_rev_msg_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "ipbx_ura_rev_msg_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'ipbx_ura_rev_msg';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "ipbx_ura_rev_msg";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"ipbx_ura_rev_msg_list.php\" ";
	}
