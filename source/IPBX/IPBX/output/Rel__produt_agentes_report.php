...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Rel__produt_agentes",
...
$params['shortTName'] = "Rel__produt_agentes";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Rel__produt_agentes_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Rel__produt_agentes_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Rel__produt_agentes_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Rel__produt_agentes_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Rel__produt_agentes_report.htm";
