...
$pageObject->body["begin"] .="<form action=\"Rel__Produtividade_Agentes_export.php\" method=POST id=frmexport name=frmexport>";
$pageObject->body["end"] .= "</form><script>".$pageObject->PrepareJS()."</script>";
$xt->assignbyref("body",$pageObject->body);

$xt->display("Rel__Produtividade_Agentes_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Produtividade_Agentes.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Produtividade_Agentes.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Produtividade_Agentes.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Produtividade_Agentes.csv");
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Rejeitadas/Não Atendid").'</td>';	
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Contribuicao Total").'</td>';	
	}
	else
	{
		echo "<td>"."Fila"."</td>";
		...
		echo "<td>"."Rejeitadas/Não Atendid"."</td>";
		echo "<td>"."Recebidas"."</td>";
		echo "<td>"."Contribuição Individual"."</td>";
		echo "<td>"."Contribuicao Total"."</td>";
	}
	echo "</tr>";
