...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"timeout_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='timeout_list.php?a=return';\"");
