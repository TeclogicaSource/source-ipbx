...
// keys array
$keys[]=AddFieldWrappers("idt_cadeado");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"cadeado_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='cadeado_list.php?a=return';\"");
