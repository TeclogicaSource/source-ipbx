...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Atendimento__Mensal_",
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Atendimento__Mensal__search.php';return false;\"");
$xt->assign("search_records_block",true);
//$xt->assign("recordcontrols_block",true);

$xt->assign("searchform_showall",true);
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Atendimento__Mensal__chart.php?a=showall';\"");

if(!GetChartXML("Atendimento__Mensal_"))
...
$templatefile = "Atendimento__Mensal__chart.htm";
