...
$strOriginalTableName="`interface`";
...
// keys array
$keys[]=AddFieldWrappers("id_interf");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"interface_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='interface_list.php?a=return';\"");
...
$xt->display("interface_import.htm");
