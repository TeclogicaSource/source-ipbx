...
$mode=SEARCH_SIMPLE;
$templatefile = "cc_receptivo_filas_atend_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "cc_receptivo_filas_atend_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'cc_receptivo_filas_atend';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "cc_receptivo_filas_atend";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("flg_revisao");
	...
	{
		$firstFieldParams['fName'] = "flg_revisao";
	...
	if(isEnableSection508())
		$xt->assign_section("flg_revisao_label","<label for=\"".GetInputElementId("flg_revisao", $id)."\">","</label>");
	else 
		$xt->assign("flg_revisao_label", true);
	
	$xt->assign("flg_revisao_fieldblock", true);		
	$xt->assignbyref("flg_revisao_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("flg_revisao_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("flg_revisao_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_flg_revisao", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("flg_revisao", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("flg_revisao")."', ".$pageObject->id.", ".$ctrlsMap.");";
	...
	{
	$contents_block["begin"].="action=\"cc_receptivo_filas_atend_list.php\" ";
	}
