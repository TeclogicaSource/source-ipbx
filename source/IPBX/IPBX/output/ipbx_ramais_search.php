...
$mode=SEARCH_SIMPLE;
$templatefile = "ipbx_ramais_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "ipbx_ramais_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'ipbx_ramais';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "ipbx_ramais";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"ipbx_ramais_list.php\" ";
	}
