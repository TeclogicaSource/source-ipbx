...
// keys array
$keys[]=AddFieldWrappers("id_tronco");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"troncos_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='troncos_list.php?a=return';\"");
