...
include("include/Minutagem_variables.php");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Minutagem_search.php';return false;\"");
$xt->assign("search_records_block",true);
//$xt->assign("recordcontrols_block",true);

$xt->assign("searchform_showall",true);
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Minutagem_chart.php?a=showall';\"");

if(!GetChartXML("Minutagem"))
...
$templatefile = "Minutagem_chart.htm";
