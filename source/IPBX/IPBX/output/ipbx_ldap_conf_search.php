...
$mode=SEARCH_SIMPLE;
$templatefile = "ipbx_ldap_conf_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "ipbx_ldap_conf_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'ipbx_ldap_conf';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "ipbx_ldap_conf";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("flg_padrao");
	...
	{
		$firstFieldParams['fName'] = "flg_padrao";
	...
	if(isEnableSection508())
		$xt->assign_section("flg_padrao_label","<label for=\"".GetInputElementId("flg_padrao", $id)."\">","</label>");
	else 
		$xt->assign("flg_padrao_label", true);
	
	$xt->assign("flg_padrao_fieldblock", true);		
	$xt->assignbyref("flg_padrao_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("flg_padrao_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("flg_padrao_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_flg_padrao", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("flg_padrao", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("flg_padrao")."', ".$pageObject->id.", ".$ctrlsMap.");";
	...
	{
	$contents_block["begin"].="action=\"ipbx_ldap_conf_list.php\" ";
	}
