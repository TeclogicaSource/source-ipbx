...
//	id_ramal_horario - 
			$value="";
				$value = ProcessLargeText(GetData($data,"id_ramal_horario", ""),"field=id%5Framal%5Fhorario".$keylink,"",MODE_PRINT);
			$record["id_ramal_horario_value"]=$value;
...
$xt->assign("id_ramal_horario_fieldheadercolumn",true);
$xt->assign("id_ramal_horario_fieldheader",true);
$xt->assign("id_ramal_horario_fieldcolumn",true);
$xt->assign("id_ramal_horario_fieldfootercolumn",true);
...
$templatefile = "sip_buddies_horario_print.htm";
