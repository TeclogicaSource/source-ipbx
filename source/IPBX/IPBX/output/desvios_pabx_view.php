...
$arr = array();
$arr['fName'] = "id_desvio";
$arr['viewFormat'] = ViewFormat("id_desvio", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "ramal";
...
//id_desvio - 
	$value="";
	$value = ProcessLargeText(GetData($data,"id_desvio", ""),"","",MODE_VIEW);
	$xt->assign("id_desvio_value",$value);
...
$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("id_desvio")."': '".(jsreplace(@$data["id_desvio"]))."', ";
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='desvios_pabx_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='desvios_pabx_view.php?".$prevlink."'\"");
	}
    else 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$xt->assign("backbutton_attrs","onclick=\"window.location.href='desvios_pabx_list.php?a=return'\"");
}

$oldtemplatefile=$templatefile;
$templatefile = "desvios_pabx_view.htm";
