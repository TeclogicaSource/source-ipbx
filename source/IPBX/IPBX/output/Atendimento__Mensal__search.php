...
include("include/Atendimento__Mensal__variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Atendimento__Mensal__search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Atendimento__Mensal__inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Atendimento__Mensal_';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Graf. Atendimento (Mensal)";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Atendimento__Mensal__chart.php\" ";
	}
