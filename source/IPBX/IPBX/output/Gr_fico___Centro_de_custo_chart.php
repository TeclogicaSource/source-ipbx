...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Gr_fico___Centro_de_custo",
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Gr_fico___Centro_de_custo_search.php';return false;\"");
$xt->assign("search_records_block",true);
//$xt->assign("recordcontrols_block",true);

$xt->assign("searchform_showall",true);
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Gr_fico___Centro_de_custo_chart.php?a=showall';\"");

if(!GetChartXML("Gr_fico___Centro_de_custo"))
...
$templatefile = "Gr_fico___Centro_de_custo_chart.htm";
