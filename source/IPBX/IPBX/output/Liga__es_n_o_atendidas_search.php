...
$mode=SEARCH_SIMPLE;
$templatefile = "Liga__es_n_o_atendidas_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Liga__es_n_o_atendidas_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Liga__es_n_o_atendidas';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Ligações não atendidas";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Liga__es_n_o_atendidas_report.php\" ";
	}
