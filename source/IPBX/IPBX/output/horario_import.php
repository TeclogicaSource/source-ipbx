...
// keys array
$keys[]=AddFieldWrappers("id_horario");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"horario_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='horario_list.php?a=return';\"");
