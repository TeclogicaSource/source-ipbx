...
$mode=SEARCH_SIMPLE;
$templatefile = "Rel__Consolidado_Fila_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Rel__Consolidado_Fila_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Rel__Consolidado_Fila';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Consolidado Fila";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Rel__Consolidado_Fila_report.php\" ";
	}
