...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Relat_rio_Agente_Fila",
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Relat_rio_Agente_Fila_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Relat_rio_Agente_Fila_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Relat_rio_Agente_Fila_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Relat_rio_Agente_Fila_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Relat_rio_Agente_Fila_report.htm";
