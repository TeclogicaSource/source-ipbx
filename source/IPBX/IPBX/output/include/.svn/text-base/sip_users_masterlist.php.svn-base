...
//	context - 
			$value="";
				$value = ProcessLargeText(GetData($data,"context", ""),"field=context".$keylink);
			$xt->assign("context_mastervalue",$value);

//	pickupgroup - 
			$value="";
				$value = ProcessLargeText(GetData($data,"pickupgroup", ""),"field=pickupgroup".$keylink);
			$xt->assign("pickupgroup_mastervalue",$value);

//	regexten - 
			$value="";
				$value = ProcessLargeText(GetData($data,"regexten", ""),"field=regexten".$keylink);
...
//	allow - 
	...
	$strTableName=$oldTableName;
	$xt->display("sip_users_masterlist.htm");
}
