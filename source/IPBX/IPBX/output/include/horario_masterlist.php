...
//	hr_inicio - Time
			$value="";
				$value = ProcessLargeText(GetData($data,"hr_inicio", "Time"),"field=hr%5Finicio".$keylink);
			$xt->assign("hr_inicio_mastervalue",$value);

//	hr_fim - Time
			$value="";
				$value = ProcessLargeText(GetData($data,"hr_fim", "Time"),"field=hr%5Ffim".$keylink);
...
//	id - 
	...
	$strTableName=$oldTableName;
	$xt->display("horario_masterlist.htm");
}
