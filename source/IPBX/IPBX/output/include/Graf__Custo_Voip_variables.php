...
$gsqlWhereExpr="(select  id_tp_interf  FROM ipbx_interf  WHERE id_interf = ct.id_interf   in (1))";
$gsqlTail="GROUP BY DATE_FORMAT(ct.calldate,'%m-%Y')";

include(getabspath("include/Graf__Custo_Voip_settings.php"));

// alias for 'SQLQuery' object
$gQuery = &$queryData_Graf__Custo_Voip;
