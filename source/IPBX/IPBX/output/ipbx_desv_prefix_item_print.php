...
//	id_desv_pref_item - 
			$value="";
				$value = ProcessLargeText(GetData($data,"id_desv_pref_item", ""),"field=id%5Fdesv%5Fpref%5Fitem".$keylink,"",MODE_PRINT);
			$record["id_desv_pref_item_value"]=$value;

//	id_desv_prefix - 
			$value="";
				$value = ProcessLargeText(GetData($data,"id_desv_prefix", ""),"field=id%5Fdesv%5Fprefix".$keylink,"",MODE_PRINT);
			$record["id_desv_prefix_value"]=$value;

//	prefixo - 
			$value="";
				$value = ProcessLargeText(GetData($data,"prefixo", ""),"field=prefixo".$keylink,"",MODE_PRINT);
			$record["prefixo_value"]=$value;
			if($col<$colsonpage)
...
$masterkeys=array();
if($mastertable=="ipbx_desv_prefix")
{
//	include proper masterprint.php code
	include("include/ipbx_desv_prefix_masterprint.php");
	$masterkeys[]=@$_SESSION[$strTableName."_masterkey1"];
	$params=array("detailtable"=>"ipbx_desv_prefix_item","keys"=>$masterkeys);
	$master=array();
	$master["func"]="DisplayMasterTableInfo_ipbx_desv_prefix";
...
$xt->assign("id_desv_pref_item_fieldheadercolumn",true);
$xt->assign("id_desv_pref_item_fieldheader",true);
$xt->assign("id_desv_pref_item_fieldcolumn",true);
$xt->assign("id_desv_pref_item_fieldfootercolumn",true);
$xt->assign("id_desv_prefix_fieldheadercolumn",true);
$xt->assign("id_desv_prefix_fieldheader",true);
$xt->assign("id_desv_prefix_fieldcolumn",true);
$xt->assign("id_desv_prefix_fieldfootercolumn",true);
$xt->assign("prefixo_fieldheadercolumn",true);
$xt->assign("prefixo_fieldheader",true);
$xt->assign("prefixo_fieldcolumn",true);
$xt->assign("prefixo_fieldfootercolumn",true);
...
$templatefile = "ipbx_desv_prefix_item_print.htm";
