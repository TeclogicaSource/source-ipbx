...
$templatefile = "contrato_trad_edit.htm";
...
//	processibng F-F_LOCAL_VLR - end
	...
	if(0 && "F-M_LOCAL_VC1_CAD"=="secret" && $url_page=="admin_users_")
			$value=md5($value);
	$evalues["F-M_LOCAL_VC1_CAD"]=$value;
...
//	processibng F-M_LOCAL_VC1_CAD - end
	...
	if(0 && "F-M_LOCAL_VC1_VLR"=="secret" && $url_page=="admin_users_")
			$value=md5($value);
	$evalues["F-M_LOCAL_VC1_VLR"]=$value;
...
if ($IsSaved && no_output_done() && !$inlineedit )
{
	...
	// redirect
	header("Location: contrato_trad_".$pageObject->getPageType().".php?".$keyGetQ);
...
/////////////////////////////////////////////////////////////
$query = $queryData_contrato_trad->Copy();
...
if(!$data)
{
	if(!$inlineedit)
	{
		header("Location: contrato_trad_list.php?a=return");
		exit();
	}
	else
		$data=array();
...
if($readevalues)
{
	...
	$data["F-F_LOCAL_CAD"]=$evalues["F-F_LOCAL_CAD"];
	$data["F-F_LOCAL_VLR"]=$evalues["F-F_LOCAL_VLR"];
	$data["F-M_LOCAL_VC1_CAD"]=$evalues["F-M_LOCAL_VC1_CAD"];
	$data["F-M_LOCAL_VC1_VLR"]=$evalues["F-M_LOCAL_VC1_VLR"];
	$data["F-M_VC2_CAD"]=$evalues["F-M_VC2_CAD"];
	$data["F-M_VC2_VLR"]=$evalues["F-M_VC2_VLR"];
	$data["F-F_LDN_CAD"]=$evalues["F-F_LDN_CAD"];
	$data["F-F_LDN_VLR"]=$evalues["F-F_LDN_VLR"];
	$data["F-F_LDI_CAD"]=$evalues["F-F_LDI_CAD"];
	$data["F-F_LDI_VLR"]=$evalues["F-F_LDI_VLR"];
	$data["F-M_LDI_CAD"]=$evalues["F-M_LDI_CAD"];
	$data["F-M_LDI_VLR"]=$evalues["F-M_LDI_VLR"];
	$data["F-M_VC3_CAD"]=$evalues["F-M_VC3_CAD"];
	$data["F-M_VC3_VLR"]=$evalues["F-M_VC3_VLR"];
}
/////////////////////////////////////////////////////////////
...
if(!$inlineedit)
{
	...
	$xt->assign('editForm', array('begin'=>'<form name="'.$formname.'" id="'.$formname.'" encType="multipart/form-data" method="post" action="contrato_trad_edit.php" '.$onsubmit.'>'.
...
//create a line where and order for the two queries
	...
	$resetEditors="";
	$unblRec="UnlockRecord('contrato_trad_edit.php','".$skeys."','',function(){window.location.href='contrato_trad_edit.php?";
	if(count($next))
	{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
	$xt->assign("backbutton_attrs","onclick=\"UnlockRecord('contrato_trad_edit.php','".$skeys."','',function(){window.location.href='contrato_trad_list.php?a=return'});return false;\"");
...
$control_F_F_LOCAL_CAD["params"]["value"]=@$data["F-F_LOCAL_CAD"];
//	Begin Add validation
$arrValidate = array();	
...
$additionalCtrlParams = array();
$additionalCtrlParams["disabled"] = !$enableCtrlsForEditing;
$control_F_F_LOCAL_CAD["params"]["additionalCtrlParams"]=$additionalCtrlParams;
if($inlineedit)
	$control_F_F_LOCAL_CAD["params"]["mode"]="inline_edit";
else
	$control_F_F_LOCAL_CAD["params"]["mode"]="edit";
if(!$detailKeys || !in_array("F-F_LOCAL_CAD", $detailKeys))	
	$xt->assign("F_F_LOCAL_CAD_editcontrol",$control_F_F_LOCAL_CAD);
else if(array_key_exists("F-F_LOCAL_CAD",$data))
{
				$value=DisplayLookupWizard("F-F_LOCAL_CAD",$data["F-F_LOCAL_CAD"],$data,"",MODE_VIEW);
...
$control_F_F_LOCAL_VLR["params"]["value"]=@$data["F-F_LOCAL_VLR"];
//	Begin Add validation
$arrValidate = array();	
...
$additionalCtrlParams = array();
$additionalCtrlParams["disabled"] = !$enableCtrlsForEditing;
$control_F_F_LOCAL_VLR["params"]["additionalCtrlParams"]=$additionalCtrlParams;
if($inlineedit)
	$control_F_F_LOCAL_VLR["params"]["mode"]="inline_edit";
else
	$control_F_F_LOCAL_VLR["params"]["mode"]="edit";
if(!$detailKeys || !in_array("F-F_LOCAL_VLR", $detailKeys))	
	$xt->assign("F_F_LOCAL_VLR_editcontrol",$control_F_F_LOCAL_VLR);
else if(array_key_exists("F-F_LOCAL_VLR",$data))
{
				$value = ProcessLargeText(GetData($data,"F-F_LOCAL_VLR", "Currency"),"field=F%2DF%5FLOCAL%5FVLR","",MODE_VIEW);
...
$control_F_M_LOCAL_VC1_CAD["params"]["value"]=@$data["F-M_LOCAL_VC1_CAD"];
//	Begin Add validation
$arrValidate = array();	
...
$additionalCtrlParams = array();
$additionalCtrlParams["disabled"] = !$enableCtrlsForEditing;
$control_F_M_LOCAL_VC1_CAD["params"]["additionalCtrlParams"]=$additionalCtrlParams;
if($inlineedit)
	$control_F_M_LOCAL_VC1_CAD["params"]["mode"]="inline_edit";
else
	$control_F_M_LOCAL_VC1_CAD["params"]["mode"]="edit";
if(!$detailKeys || !in_array("F-M_LOCAL_VC1_CAD", $detailKeys))	
	$xt->assign("F_M_LOCAL_VC1_CAD_editcontrol",$control_F_M_LOCAL_VC1_CAD);
else if(array_key_exists("F-M_LOCAL_VC1_CAD",$data))
{
				$value=DisplayLookupWizard("F-M_LOCAL_VC1_CAD",$data["F-M_LOCAL_VC1_CAD"],$data,"",MODE_VIEW);
...
$control_F_M_LOCAL_VC1_VLR["params"]["value"]=@$data["F-M_LOCAL_VC1_VLR"];
//	Begin Add validation
$arrValidate = array();	
$validatetype = getJsValidatorName("Currency");
$arrValidate['basicValidate'][] = $validatetype;
...
$additionalCtrlParams = array();
$additionalCtrlParams["disabled"] = !$enableCtrlsForEditing;
$control_F_M_LOCAL_VC1_VLR["params"]["additionalCtrlParams"]=$additionalCtrlParams;
if($inlineedit)
	$control_F_M_LOCAL_VC1_VLR["params"]["mode"]="inline_edit";
else
	$control_F_M_LOCAL_VC1_VLR["params"]["mode"]="edit";
if(!$detailKeys || !in_array("F-M_LOCAL_VC1_VLR", $detailKeys))	
	$xt->assign("F_M_LOCAL_VC1_VLR_editcontrol",$control_F_M_LOCAL_VC1_VLR);
else if(array_key_exists("F-M_LOCAL_VC1_VLR",$data))
{
				$value = ProcessLargeText(GetData($data,"F-M_LOCAL_VC1_VLR", "Currency"),"field=F%2DM%5FLOCAL%5FVC1%5FVLR","",MODE_VIEW);
...
$control_F_M_VC2_CAD["params"]["value"]=@$data["F-M_VC2_CAD"];
//	Begin Add validation
$arrValidate = array();	
...
$additionalCtrlParams = array();
$additionalCtrlParams["disabled"] = !$enableCtrlsForEditing;
$control_F_M_VC2_CAD["params"]["additionalCtrlParams"]=$additionalCtrlParams;
if($inlineedit)
	$control_F_M_VC2_CAD["params"]["mode"]="inline_edit";
else
	$control_F_M_VC2_CAD["params"]["mode"]="edit";
if(!$detailKeys || !in_array("F-M_VC2_CAD", $detailKeys))	
	$xt->assign("F_M_VC2_CAD_editcontrol",$control_F_M_VC2_CAD);
else if(array_key_exists("F-M_VC2_CAD",$data))
{
				$value=DisplayLookupWizard("F-M_VC2_CAD",$data["F-M_VC2_CAD"],$data,"",MODE_VIEW);
...
$control_F_M_VC2_VLR["params"]["value"]=@$data["F-M_VC2_VLR"];
//	Begin Add validation
$arrValidate = array();	
$validatetype = getJsValidatorName("Currency");
$arrValidate['basicValidate'][] = $validatetype;
...
$additionalCtrlParams = array();
$additionalCtrlParams["disabled"] = !$enableCtrlsForEditing;
$control_F_M_VC2_VLR["params"]["additionalCtrlParams"]=$additionalCtrlParams;
if($inlineedit)
	$control_F_M_VC2_VLR["params"]["mode"]="inline_edit";
else
	$control_F_M_VC2_VLR["params"]["mode"]="edit";
if(!$detailKeys || !in_array("F-M_VC2_VLR", $detailKeys))	
	$xt->assign("F_M_VC2_VLR_editcontrol",$control_F_M_VC2_VLR);
else if(array_key_exists("F-M_VC2_VLR",$data))
{
				$value = ProcessLargeText(GetData($data,"F-M_VC2_VLR", "Currency"),"field=F%2DM%5FVC2%5FVLR","",MODE_VIEW);
...
$control_F_F_LDN_CAD["params"]["value"]=@$data["F-F_LDN_CAD"];
//	Begin Add validation
$arrValidate = array();	
...
$additionalCtrlParams = array();
$additionalCtrlParams["disabled"] = !$enableCtrlsForEditing;
$control_F_F_LDN_CAD["params"]["additionalCtrlParams"]=$additionalCtrlParams;
if($inlineedit)
	$control_F_F_LDN_CAD["params"]["mode"]="inline_edit";
else
	$control_F_F_LDN_CAD["params"]["mode"]="edit";
if(!$detailKeys || !in_array("F-F_LDN_CAD", $detailKeys))	
	$xt->assign("F_F_LDN_CAD_editcontrol",$control_F_F_LDN_CAD);
else if(array_key_exists("F-F_LDN_CAD",$data))
{
				$value=DisplayLookupWizard("F-F_LDN_CAD",$data["F-F_LDN_CAD"],$data,"",MODE_VIEW);
...
$control_F_F_LDN_VLR["params"]["value"]=@$data["F-F_LDN_VLR"];
//	Begin Add validation
$arrValidate = array();	
$validatetype = getJsValidatorName("Currency");
$arrValidate['basicValidate'][] = $validatetype;
...
$additionalCtrlParams = array();
$additionalCtrlParams["disabled"] = !$enableCtrlsForEditing;
$control_F_F_LDN_VLR["params"]["additionalCtrlParams"]=$additionalCtrlParams;
if($inlineedit)
	$control_F_F_LDN_VLR["params"]["mode"]="inline_edit";
else
	$control_F_F_LDN_VLR["params"]["mode"]="edit";
if(!$detailKeys || !in_array("F-F_LDN_VLR", $detailKeys))	
	$xt->assign("F_F_LDN_VLR_editcontrol",$control_F_F_LDN_VLR);
else if(array_key_exists("F-F_LDN_VLR",$data))
{
				$value = ProcessLargeText(GetData($data,"F-F_LDN_VLR", "Currency"),"field=F%2DF%5FLDN%5FVLR","",MODE_VIEW);
...
$control_F_F_LDI_CAD["params"]["value"]=@$data["F-F_LDI_CAD"];
//	Begin Add validation
$arrValidate = array();	
...
$additionalCtrlParams = array();
$additionalCtrlParams["disabled"] = !$enableCtrlsForEditing;
$control_F_F_LDI_CAD["params"]["additionalCtrlParams"]=$additionalCtrlParams;
if($inlineedit)
	$control_F_F_LDI_CAD["params"]["mode"]="inline_edit";
else
	$control_F_F_LDI_CAD["params"]["mode"]="edit";
if(!$detailKeys || !in_array("F-F_LDI_CAD", $detailKeys))	
	$xt->assign("F_F_LDI_CAD_editcontrol",$control_F_F_LDI_CAD);
else if(array_key_exists("F-F_LDI_CAD",$data))
{
				$value=DisplayLookupWizard("F-F_LDI_CAD",$data["F-F_LDI_CAD"],$data,"",MODE_VIEW);
...
$control_F_F_LDI_VLR["params"]["value"]=@$data["F-F_LDI_VLR"];
//	Begin Add validation
$arrValidate = array();	
$validatetype = getJsValidatorName("Currency");
$arrValidate['basicValidate'][] = $validatetype;
...
$additionalCtrlParams = array();
$additionalCtrlParams["disabled"] = !$enableCtrlsForEditing;
$control_F_F_LDI_VLR["params"]["additionalCtrlParams"]=$additionalCtrlParams;
if($inlineedit)
	$control_F_F_LDI_VLR["params"]["mode"]="inline_edit";
else
	$control_F_F_LDI_VLR["params"]["mode"]="edit";
if(!$detailKeys || !in_array("F-F_LDI_VLR", $detailKeys))	
	$xt->assign("F_F_LDI_VLR_editcontrol",$control_F_F_LDI_VLR);
else if(array_key_exists("F-F_LDI_VLR",$data))
{
				$value = ProcessLargeText(GetData($data,"F-F_LDI_VLR", "Currency"),"field=F%2DF%5FLDI%5FVLR","",MODE_VIEW);
...
$control_F_M_LDI_CAD["params"]["value"]=@$data["F-M_LDI_CAD"];
//	Begin Add validation
$arrValidate = array();	
...
$additionalCtrlParams = array();
$additionalCtrlParams["disabled"] = !$enableCtrlsForEditing;
$control_F_M_LDI_CAD["params"]["additionalCtrlParams"]=$additionalCtrlParams;
if($inlineedit)
	$control_F_M_LDI_CAD["params"]["mode"]="inline_edit";
else
	$control_F_M_LDI_CAD["params"]["mode"]="edit";
if(!$detailKeys || !in_array("F-M_LDI_CAD", $detailKeys))	
	$xt->assign("F_M_LDI_CAD_editcontrol",$control_F_M_LDI_CAD);
else if(array_key_exists("F-M_LDI_CAD",$data))
{
				$value=DisplayLookupWizard("F-M_LDI_CAD",$data["F-M_LDI_CAD"],$data,"",MODE_VIEW);
...
$control_F_M_LDI_VLR["params"]["value"]=@$data["F-M_LDI_VLR"];
//	Begin Add validation
$arrValidate = array();	
$validatetype = getJsValidatorName("Currency");
$arrValidate['basicValidate'][] = $validatetype;
...
$additionalCtrlParams = array();
$additionalCtrlParams["disabled"] = !$enableCtrlsForEditing;
$control_F_M_LDI_VLR["params"]["additionalCtrlParams"]=$additionalCtrlParams;
if($inlineedit)
	$control_F_M_LDI_VLR["params"]["mode"]="inline_edit";
else
	$control_F_M_LDI_VLR["params"]["mode"]="edit";
if(!$detailKeys || !in_array("F-M_LDI_VLR", $detailKeys))	
	$xt->assign("F_M_LDI_VLR_editcontrol",$control_F_M_LDI_VLR);
else if(array_key_exists("F-M_LDI_VLR",$data))
{
				$value = ProcessLargeText(GetData($data,"F-M_LDI_VLR", "Currency"),"field=F%2DM%5FLDI%5FVLR","",MODE_VIEW);
...
$control_F_M_VC3_CAD["params"]["value"]=@$data["F-M_VC3_CAD"];
//	Begin Add validation
$arrValidate = array();	
...
$additionalCtrlParams = array();
$additionalCtrlParams["disabled"] = !$enableCtrlsForEditing;
$control_F_M_VC3_CAD["params"]["additionalCtrlParams"]=$additionalCtrlParams;
if($inlineedit)
	$control_F_M_VC3_CAD["params"]["mode"]="inline_edit";
else
	$control_F_M_VC3_CAD["params"]["mode"]="edit";
if(!$detailKeys || !in_array("F-M_VC3_CAD", $detailKeys))	
	$xt->assign("F_M_VC3_CAD_editcontrol",$control_F_M_VC3_CAD);
else if(array_key_exists("F-M_VC3_CAD",$data))
{
				$value=DisplayLookupWizard("F-M_VC3_CAD",$data["F-M_VC3_CAD"],$data,"",MODE_VIEW);
...
$control_F_M_VC3_VLR["params"]["value"]=@$data["F-M_VC3_VLR"];
//	Begin Add validation
$arrValidate = array();	
$validatetype = getJsValidatorName("Currency");
$arrValidate['basicValidate'][] = $validatetype;
...
$additionalCtrlParams = array();
$additionalCtrlParams["disabled"] = !$enableCtrlsForEditing;
$control_F_M_VC3_VLR["params"]["additionalCtrlParams"]=$additionalCtrlParams;
if($inlineedit)
	$control_F_M_VC3_VLR["params"]["mode"]="inline_edit";
else
	$control_F_M_VC3_VLR["params"]["mode"]="edit";
if(!$detailKeys || !in_array("F-M_VC3_VLR", $detailKeys))	
	$xt->assign("F_M_VC3_VLR_editcontrol",$control_F_M_VC3_VLR);
else if(array_key_exists("F-M_VC3_VLR",$data))
{
				$value = ProcessLargeText(GetData($data,"F-M_VC3_VLR", "Currency"),"field=F%2DM%5FVC3%5FVLR","",MODE_VIEW);
...
if($lockingObj && $enableCtrlsForEditing)
	$pageObject->AddJSCode("window.timeid".$id."=setInterval( function() {ConfirmLock('contrato_trad_edit.php','".jsreplace($strTableName)."','".$skeys."',".$id.",'".$inlineedit."');},".($lockingObj->ConfirmTime*1000).");");
