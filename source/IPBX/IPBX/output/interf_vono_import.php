...
// keys array
$keys[]=AddFieldWrappers("id_interf_vono");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"interf_vono_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='interf_vono_list.php?a=return';\"");
...
$xt->display("interf_vono_import.htm");
