...
$mode=SEARCH_SIMPLE;
$templatefile = "Discadas___Centro_de_custo_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Discadas___Centro_de_custo_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Discadas___Centro_de_custo';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Detalhado - Centro de custo";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Discadas___Centro_de_custo_report.php\" ";
	}
