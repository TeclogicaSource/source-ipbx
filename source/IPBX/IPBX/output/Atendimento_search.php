...
$mode=SEARCH_SIMPLE;
$templatefile = "Atendimento_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Atendimento_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Atendimento';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Atendimento";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Atendimento_report.php\" ";
	}
