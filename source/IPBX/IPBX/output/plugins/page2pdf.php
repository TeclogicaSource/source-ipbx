...
var pdiv = window.parent.document.getElementById("progress");
window.parent.pdfbuilt=1;
pdiv.innerHTML='<p><?php echo jsreplace("Arquivo PDF criado. Faça o download usando este");?> <a href="getpdf.php?table=<?php echo GetTableURL();?>&id=<?php echo $outfileid;?>"><?php echo jsreplace("link");?></a></p><br>';
</script>
<div id="done"></div>
