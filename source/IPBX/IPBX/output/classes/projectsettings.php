...
function GetTableURL($table = "")
{
	...
	if("Acesso de agentes" == $table) 
		return "Acesso_de_agentes";
	if("parametros" == $table) 
		return "parametros";
	...
	if("timeout" == $table) 
		return "timeout";
	if("cc_receptivo_agentes" == $table) 
		return "cc_receptivo_agentes";
	if("central" == $table) 
		return "central";
	...
	if("Rel. Lig. Externas Transferidas" == $table) 
		return "Lig__Externas_Transferidas";
	if("Rel. Ligações não atendidas" == $table) 
		return "Liga__es_n_o_atendidas";
	...
	if("Rel. Atendimento por Fila" == $table) 
		return "Rel__Atendimento_por_Fila";
...
{	
	...
	if("timeout" == $shortTName) 
		return "timeout";
	if("cc_receptivo_agentes" == $shortTName) 
		return "cc_receptivo_agentes";
	...
	if("Lig__Externas_Transferidas" == $shortTName) 
		return "Rel. Lig. Externas Transferidas";
	if("Liga__es_n_o_atendidas" == $shortTName) 
		return "Rel. Ligações não atendidas";
	...
	if("ipbx_sincronismo" == $shortTName) 
		return "ipbx_sincronismo";
	if("Rel__Atendimento_por_Fila" == $shortTName) 
		return "Rel. Atendimento por Fila";
