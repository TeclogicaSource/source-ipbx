...
class ListPage extends RunnerPage 
{
	...
	function addCommonHtml() 
	{
		...
		if($this->is508) {
			$this->body["begin"].= "<a href=\"#skipdata\" title=\""."Pular para dados em tabela"."\" style=\"width:1px;height:1px;overflow:hidden;display:block;\">"."Pular para dados em tabela"."</a>";
			$this->body["begin"].= "<a href=\"#skipmenu\" title=\""."Ir para o menu"."\" style=\"width:1px;height:1px;overflow:hidden;display:block;\">"."Ir para o menu"."</a>";
			$this->body["begin"].= "<a href=\"#skipsearch\" title=\""."Passar à pesquisa"."\" style=\"width:1px;height:1px;overflow:hidden;display:block;\">"."Passar à pesquisa"."</a>";
			$this->body["begin"].= "<a href=\"templates/helpshortcut.htm\" title=\""."Referência de hotkeys"."\" style=\"width:1px;height:1px;overflow:hidden;display:block;\">"."Referência de hotkeys"."</a>";
		}
	...
	function deleteRecords() 
	{
		...
		foreach($this->selectedRecs as $keys) 
		{
			...
			if($this->lockingObj)
			{
				...
				$lockSQL="select * from ".AddTableWrappers("ipbx_locking")." where ".AddFieldWrappers("keys")."='".$lockWhere."' and ".AddFieldWrappers("table")."='".$this->origTName."' and ".AddFieldWrappers("action")."=1";
	...
	function deleteSelectedAttrs()
	{
		$this->xt->assign("deleteselectedlink_attrs", "name=\"delete_selected".$this->id."\" onclick=\"
				if(\$('input[@type=checkbox][@checked][@name^=selection]').length && confirm('"."Tem certeza que desejar eliminar estes registros?"."')){ frmAdmin".$this->id.".submit();". 
		...
		if(! $this->numRowsFromSQLFromSQL) 
		{
			...
			$this->xt->assign("message",($this->is508 == true ? "<a name=\"skipdata\"></a>" : "").$message);
				...
				if($this->maxPages > 1) 
				{
					...
					if($counterstart != 1) 
					{
						$pagination.= "<a href='JavaScript:GotoPage".$this->id."(1);' style='TEXT-DECORATION: none;'>"."Primeiro"."</a>";
						$pagination.= "&nbsp;:&nbsp;";
						$pagination.= "<a href='JavaScript:GotoPage".$this->id."(".($counterstart - 1).");' style='TEXT-DECORATION: none;'>"."Anterior"."</a>";
						$pagination.= "&nbsp;";
					}
					$pagination.= "<b>[</b>";
					...
					if($counterend != $this->maxPages) 
					{
						$pagination.= "&nbsp;<a href='JavaScript:GotoPage".$this->id."(".($counterend + 1).");' style='TEXT-DECORATION: none;'>"."Próximo"."</a>";
						$pagination.= "&nbsp;:&nbsp;";
						$pagination.="&nbsp;<a href='JavaScript:GotoPage".$this->id."(".($this->maxPages).");' style='TEXT-DECORATION: none;'>"."Último"."</a>";
					}
