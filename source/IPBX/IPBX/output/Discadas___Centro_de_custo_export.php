...
include("include/Discadas___Centro_de_custo_variables.php");
...
$pageObject->body["begin"] .="<form action=\"Discadas___Centro_de_custo_export.php\" method=POST id=frmexport name=frmexport>";
$pageObject->body["end"] .= "</form><script>".$pageObject->PrepareJS()."</script>";
$xt->assignbyref("body",$pageObject->body);

$xt->display("Discadas___Centro_de_custo_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=Discadas___Centro_de_custo.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=Discadas___Centro_de_custo.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=Discadas___Centro_de_custo.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=Discadas___Centro_de_custo.csv");
