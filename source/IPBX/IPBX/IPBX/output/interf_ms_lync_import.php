...
// keys array
$keys[]=AddFieldWrappers("id_ms_lync");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"interf_ms_lync_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='interf_ms_lync_list.php?a=return';\"");
...
$xt->display("interf_ms_lync_import.htm");
