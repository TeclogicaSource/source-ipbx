...
$arr = array();
$arr['fName'] = "ramal";
$arr['viewFormat'] = ViewFormat("ramal", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Nome";
$arr['viewFormat'] = ViewFormat("Nome", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "idt_custo";
...
//ramal - 
	$value="";
	$value=DisplayLookupWizard("ramal",$data["ramal"],$data,$keylink,MODE_VIEW);
	$xt->assign("ramal_value",$value);
	$xt->assign("ramal_fieldblock",true);
////////////////////////////////////////////
//Nome - 
	$value="";
	$value = ProcessLargeText(GetData($data,"Nome", ""),"","",MODE_VIEW);
	$xt->assign("Nome_value",$value);
	$xt->assign("Nome_fieldblock",true);
////////////////////////////////////////////
//idt_custo - 
	$value="";
	$value=DisplayLookupWizard("idt_custo",$data["idt_custo"],$data,$keylink,MODE_VIEW);
...
//id_horario - 
	$value="";
	$value=DisplayLookupWizard("id_horario",$data["id_horario"],$data,$keylink,MODE_VIEW);
...
$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("idt_tronco")."': '".(jsreplace(@$data["idt_tronco"]))."', ";
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='pabx_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='pabx_view.php?".$prevlink."'\"");
	}
    else 
