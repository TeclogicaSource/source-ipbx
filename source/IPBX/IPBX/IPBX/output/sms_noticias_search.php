...
$mode=SEARCH_SIMPLE;
$templatefile = "sms_noticias_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "sms_noticias_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'sms_noticias';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "sms_noticias";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("dsc_noticia");
	...
	{
		$firstFieldParams['fName'] = "dsc_noticia";
	...
	$xt->assignbyref("dsc_noticia_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("dsc_noticia_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("dsc_noticia_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_dsc_noticia", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("dsc_noticia", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("dsc_noticia")."', ".$pageObject->id.", ".$ctrlsMap.");";
	...
	{
	$contents_block["begin"].="action=\"sms_noticias_list.php\" ";
	}
