...
$xt->assign("NivelServicoOperacaoContratado_fieldheader",true);
$xt->assign("NivelServicoOperacaoRealizado_fieldheader",true);
$xt->assign("NivelServicoOperacaoQuantidade_fieldheader",true);
...
$templatefile = "Rel_Produtividade_da_Fila_print.htm";
