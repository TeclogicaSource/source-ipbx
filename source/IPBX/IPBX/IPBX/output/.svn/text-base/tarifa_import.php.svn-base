...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"tarifa_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='tarifa_list.php?a=return';\"");
