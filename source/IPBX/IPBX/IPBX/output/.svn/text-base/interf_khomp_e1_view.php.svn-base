...
$arr = array();
$arr['fName'] = "id_k_e1";
$arr['viewFormat'] = ViewFormat("id_k_e1", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "dsc_interf";
$arr['viewFormat'] = ViewFormat("dsc_interf", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
...
$arr = array();
$arr['fName'] = "board";
$arr['viewFormat'] = ViewFormat("board", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "link";
$arr['viewFormat'] = ViewFormat("link", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
...
//id_k_e1 - 
	$value="";
	$value = ProcessLargeText(GetData($data,"id_k_e1", ""),"","",MODE_VIEW);
	$xt->assign("id_k_e1_value",$value);
	$xt->assign("id_k_e1_fieldblock",true);
////////////////////////////////////////////
//dsc_interf - 
	$value="";
	$value = ProcessLargeText(GetData($data,"dsc_interf", ""),"","",MODE_VIEW);
	$xt->assign("dsc_interf_value",$value);
...
//board - 
	$value="";
	$value = ProcessLargeText(GetData($data,"board", ""),"","",MODE_VIEW);
	$xt->assign("board_value",$value);
	$xt->assign("board_fieldblock",true);
////////////////////////////////////////////
//link - 
	$value="";
	$value = ProcessLargeText(GetData($data,"link", ""),"","",MODE_VIEW);
	$xt->assign("link_value",$value);
...
$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("id_k_e1")."': '".(jsreplace(@$data["id_k_e1"]))."', ";
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='interf_khomp_e1_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='interf_khomp_e1_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "interf_khomp_e1_view.htm";
