...
$mode=SEARCH_SIMPLE;
$templatefile = "Lig__Externas_Transferidas_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Lig__Externas_Transferidas_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Lig__Externas_Transferidas';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Lig. Externas Transferidas";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Lig__Externas_Transferidas_report.php\" ";
	}
