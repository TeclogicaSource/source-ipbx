...
if($mastertable=="plano_discagem_regiao")
{
	$where ="";
		$where.= GetFullFieldName("id_regiao")."=".make_db_value("id_regiao",$_SESSION[$strTableName."_masterkey1"]);
}
...
$xt->display("planos_discagem_detailspreview.htm");
if($mode!="inline")
