...
$pageObject->body["begin"] .="<form action=\"timeout_export.php\" method=POST id=frmexport name=frmexport>";
$pageObject->body["end"] .= "</form><script>".$pageObject->PrepareJS()."</script>";
$xt->assignbyref("body",$pageObject->body);

$xt->display("timeout_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=timeout.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=timeout.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=timeout.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=timeout.csv");
