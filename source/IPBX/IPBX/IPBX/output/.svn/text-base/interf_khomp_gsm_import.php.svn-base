...
// keys array
$keys[]=AddFieldWrappers("id_k_gsm");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"interf_khomp_gsm_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='interf_khomp_gsm_list.php?a=return';\"");
...
$xt->display("interf_khomp_gsm_import.htm");
