...
$arr = array();
$arr['fName'] = "id_k_gsm";
$arr['viewFormat'] = ViewFormat("id_k_gsm", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
...
//id_k_gsm - 
	$value="";
	$value = ProcessLargeText(GetData($data,"id_k_gsm", ""),"","",MODE_VIEW);
	$xt->assign("id_k_gsm_value",$value);
	$xt->assign("id_k_gsm_fieldblock",true);
////////////////////////////////////////////
//id_contrato - 
	$value="";
...
$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("id_k_gsm")."': '".(jsreplace(@$data["id_k_gsm"]))."', ";
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='interf_khomp_gsm_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='interf_khomp_gsm_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "interf_khomp_gsm_view.htm";
