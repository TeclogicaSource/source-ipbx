...
$mode=SEARCH_SIMPLE;
$templatefile = "sms_grupo_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "sms_grupo_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'sms_grupo';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "sms_grupo";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"sms_grupo_list.php\" ";
	}
