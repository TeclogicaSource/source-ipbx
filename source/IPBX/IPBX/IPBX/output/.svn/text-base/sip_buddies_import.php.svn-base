...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"sip_buddies_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='sip_buddies_list.php?a=return';\"");
...
$xt->display("sip_buddies_import.htm");
