...
if (@$_REQUEST["format"]=="excel")
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Detalh__Chamadas.xls");
...
else if (@$_REQUEST["format"]=="word")
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Detalh__Chamadas.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$params['shortTName'] = "Rel__Detalh__Chamadas";
...
$xt->assign("tp_espera_fieldheader",true);
$xt->assign("tp_atendimento_fieldheader",true);
$xt->assign("tptotal_fieldheader",true);
...
$templatefile = "Rel__Detalh__Chamadas_print.htm";
