...
//	id_desvio - 
			$value="";
				$value = ProcessLargeText(GetData($data,"id_desvio", ""),"field=id%5Fdesvio".$keylink,"",MODE_PRINT);
			$record["id_desvio_value"]=$value;

//	ramal - 
			$value="";
				$value = ProcessLargeText(GetData($data,"ramal", ""),"field=ramal".$keylink,"",MODE_PRINT);
			$record["ramal_value"]=$value;

//	destino - 
			$value="";
				$value = ProcessLargeText(GetData($data,"destino", ""),"field=destino".$keylink,"",MODE_PRINT);
			$record["destino_value"]=$value;
...
$xt->assign("ramal_fieldheadercolumn",true);
$xt->assign("ramal_fieldheader",true);
$xt->assign("ramal_fieldcolumn",true);
$xt->assign("ramal_fieldfootercolumn",true);
...
$templatefile = "desvios_pabx_print.htm";
