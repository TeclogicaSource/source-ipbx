...
$xt->assign("Discar_fieldheadercolumn",true);
$xt->assign("Discar_fieldheader",true);
$xt->assign("Discar_fieldcolumn",true);
$xt->assign("Discar_fieldfootercolumn",true);
...
$templatefile = "v_contatos_print.htm";
