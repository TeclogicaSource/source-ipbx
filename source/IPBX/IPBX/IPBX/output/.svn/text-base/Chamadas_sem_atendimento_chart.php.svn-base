...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Chamadas_sem_atendimento",
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Chamadas_sem_atendimento_search.php';return false;\"");
$xt->assign("search_records_block",true);
//$xt->assign("recordcontrols_block",true);

$xt->assign("searchform_showall",true);
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Chamadas_sem_atendimento_chart.php?a=showall';\"");

if(!GetChartXML("Chamadas_sem_atendimento"))
...
$templatefile = "Chamadas_sem_atendimento_chart.htm";
