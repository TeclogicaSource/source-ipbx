...
// keys array
$keys[]=AddFieldWrappers("id_ipbx_ura_rev_msg");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"ipbx_ura_rev_msg_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='ipbx_ura_rev_msg_list.php?a=return';\"");
...
$xt->display("ipbx_ura_rev_msg_import.htm");
