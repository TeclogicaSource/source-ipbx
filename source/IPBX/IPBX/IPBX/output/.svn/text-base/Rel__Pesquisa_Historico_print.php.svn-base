...
if (@$_REQUEST["format"]=="excel")
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Pesquisa_Historico.xls");
...
else if (@$_REQUEST["format"]=="word")
{
	...
	header("Content-Disposition: attachment;Filename=Rel__Pesquisa_Historico.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("dsc_pesquisa_fieldheader",true);
$xt->assign("dsc_mensagem_fieldheader",true);
$xt->assign("nm_telefone_fieldheader",true);
$xt->assign("nm_ramal_fieldheader",true);
$xt->assign("usuario_fieldheader",true);
$xt->assign("resp_usuario_fieldheader",true);
$xt->assign("dt_resp_fieldheader",true);
$xt->assign("nr_ordem_fieldheader",true);
$xt->assign("txt_resp_fieldheader",true);
...
$templatefile = "Rel__Pesquisa_Historico_print.htm";
