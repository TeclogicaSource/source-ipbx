...
$mode=SEARCH_SIMPLE;
$templatefile = "sip_users_horario_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "sip_users_horario_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'sip_users_horario';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "sip_users_horario";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("dsc_plano");
	...
	{
		$firstFieldParams['fName'] = "dsc_plano";
	...
	$xt->assignbyref("dsc_plano_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("dsc_plano_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("dsc_plano_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_dsc_plano", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("dsc_plano", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("dsc_plano")."', ".$pageObject->id.", ".$ctrlsMap.");";
	...
	{
	$contents_block["begin"].="action=\"sip_users_horario_list.php\" ";
	}
