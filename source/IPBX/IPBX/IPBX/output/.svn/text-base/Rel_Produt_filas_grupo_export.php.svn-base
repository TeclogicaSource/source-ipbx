...
include("include/Rel_Produt_filas_grupo_variables.php");
...
$pageObject->body["begin"] .="<form action=\"Rel_Produt_filas_grupo_export.php\" method=POST id=frmexport name=frmexport>";
$pageObject->body["end"] .= "</form><script>".$pageObject->PrepareJS()."</script>";
$xt->assignbyref("body",$pageObject->body);

$xt->display("Rel_Produt_filas_grupo_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=Rel_Produt_filas_grupo.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=Rel_Produt_filas_grupo.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=Rel_Produt_filas_grupo.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=Rel_Produt_filas_grupo.csv");
...
// write data rows
	...
	while((!$nPageSize || $iNumberOfRows<$nPageSize) && $row)
	{
		...
		$values["nm_grupo"] = DisplayLookupWizard("nm_grupo",$row["nm_grupo"],$row,"",MODE_EXPORT);
			$format="Number";
			$values["Receb."] = htmlspecialchars($row["Receb."]);
			$format="Number";
			$values["Atend."] = htmlspecialchars($row["Atend."]);
			$format="Number";
			$values["Aband."] = htmlspecialchars($row["Aband."]);
			$format="";
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Receb.").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Atend.").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Aband.").'</td>';	
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Aband.Contr.").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Aband.Real.").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Nivel Servico Espera Contratado").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Nivel Servico Espera Realizado").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Nivel Servico Espera Quantidade").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Nivel Servico Atendimento Contratado").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Nivel Servico Atendimento Realizado").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Nivel Servico Atendimento Quantidade").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Nivel Servico Operacao Contratado").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Nivel Servico Operacao Realizado").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Nivel Servico Operacao Quantidade").'</td>';	
	}
	else
	{
		echo "<td>"."Mes"."</td>";
		...
		echo "<td>"."TMA"."</td>";
		echo "<td>"."TMO"."</td>";
		echo "<td>"."Aband.Contr."."</td>";
		echo "<td>"."Aband.Real."."</td>";
		echo "<td>"."Nivel Servico Espera Contratado"."</td>";
		echo "<td>"."Nivel Servico Espera Realizado"."</td>";
		echo "<td>"."Nivel Servico Espera Quantidade"."</td>";
		echo "<td>"."Nivel Servico Atendimento Contratado"."</td>";
		echo "<td>"."Nivel Servico Atendimento Realizado"."</td>";
		echo "<td>"."Nivel Servico Atendimento Quantidade"."</td>";
		echo "<td>"."Nivel Servico Operacao Contratado"."</td>";
		echo "<td>"."Nivel Servico Operacao Realizado"."</td>";
		echo "<td>"."Nivel Servico Operacao Quantidade"."</td>";
	}
	echo "</tr>";
