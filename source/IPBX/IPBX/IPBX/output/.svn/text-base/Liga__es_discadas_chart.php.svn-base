...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Liga__es_discadas",
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Liga__es_discadas_search.php';return false;\"");
$xt->assign("search_records_block",true);
//$xt->assign("recordcontrols_block",true);

$xt->assign("searchform_showall",true);
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Liga__es_discadas_chart.php?a=showall';\"");

if(!GetChartXML("Liga__es_discadas"))
...
$templatefile = "Liga__es_discadas_chart.htm";
