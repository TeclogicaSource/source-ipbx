...
include("include/Lig_Custo_por_tronco_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Lig_Custo_por_tronco_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Lig_Custo_por_tronco_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Lig_Custo_por_tronco';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Lig Custo por tronco";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Lig_Custo_por_tronco_report.php\" ";
	}
