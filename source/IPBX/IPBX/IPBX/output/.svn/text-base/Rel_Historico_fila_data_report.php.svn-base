...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Rel_Historico_fila_data",
...
$params['shortTName'] = "Rel_Historico_fila_data";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Rel_Historico_fila_data_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Rel_Historico_fila_data_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Rel_Historico_fila_data_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Rel_Historico_fila_data_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Rel_Historico_fila_data_report.htm";
