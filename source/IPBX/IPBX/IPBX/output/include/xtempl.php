...
class XTempl
{
	...
	function XTempl()
	{
		...
		$this->assign_function("Graf__Atendimento_chart","xt_showchart",array("chartname"=>"Graf__Atendimento","table"=>"Graf. Atendimento"));
		$this->assign_function("Atendimento__Mensal__chart","xt_showchart",array("chartname"=>"Atendimento__Mensal_","table"=>"Graf. Atendimento (Mensal)"));
		$this->assign_function("Graf__Custo_chart","xt_showchart",array("chartname"=>"Graf__Custo","table"=>"Graf. Custo Trad"));
		$this->assign_function("Graf__Custo_Voip_chart","xt_showchart",array("chartname"=>"Graf__Custo_Voip","table"=>"Graf. Custo Voip"));
		$this->assign_function("Minutagem_chart","xt_showchart",array("chartname"=>"Minutagem","table"=>"Graf. Minutagem Trad"));
		$this->assign_function("Graf__Minutagem_Voip_chart","xt_showchart",array("chartname"=>"Graf__Minutagem_Voip","table"=>"Graf. Minutagem Voip"));
		$this->assign_function("Liga__es_discadas_chart","xt_showchart",array("chartname"=>"Liga__es_discadas","table"=>"Graf. Lig. Discadas"));
		$this->assign_function("Gr_fico___Centro_de_custo_chart","xt_showchart",array("chartname"=>"Gr_fico___Centro_de_custo","table"=>"Graf. Centro de custo"));
		$this->assign_function("Graf__Custo_GSM_chart","xt_showchart",array("chartname"=>"Graf__Custo_GSM","table"=>"Graf. Custo GSM"));
		$this->assign_function("Graf__Minutos_GSM_chart","xt_showchart",array("chartname"=>"Graf__Minutos_GSM","table"=>"Graf. Minutagem GSM"));
		$this->assign_function("Chamadas_sem_atendimento_chart","xt_showchart",array("chartname"=>"Chamadas_sem_atendimento","table"=>"Graf. Chamadas sem atendimento"));
		$this->assign_function("Graf_per__temp_espera_por_dia_chart","xt_showchart",array("chartname"=>"Graf_per__temp_espera_por_dia","table"=>"Graf. Perfil Tempo de espera por dia"));
		$this->assign_function("Graf__Historico_fila_data_chart","xt_showchart",array("chartname"=>"Graf__Historico_fila_data","table"=>"Graf. Historico fila data"));
		$this->assign_function("Graf__Historico_fila_hora_chart","xt_showchart",array("chartname"=>"Graf__Historico_fila_hora","table"=>"Graf. Historico fila hora"));
		$this->assign_function("Graf__perfil_atendimento_chart","xt_showchart",array("chartname"=>"Graf__perfil_atendimento","table"=>"Graf. perfil atendimento"));
