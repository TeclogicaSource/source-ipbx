...
function checkTableName($shortTName, $type=false)
{
	...
	if ("Rel__Produt__Agentes" == $shortTName && ($type===false || ($type!==false && $type == 2)))
	{
		return true;	
	}
...
function GetTablesList($pdfMode=false)
{
	...
	$strPerm = GetUserPermissions("Rel. Produt. Agentes");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Rel. Produt. Agentes";
	}
...
function GetTableURL($table="")
{
	...
	if("Rel. Produt. Agentes"==$table) 
		return "Rel__Produt__Agentes";
...
{	
	...
	if("Rel__Produt__Agentes"==$shortTName) 
		return "Rel. Produt. Agentes";
...
{	
	...
	if(array_key_exists("Rel. Produt filas grupo por mes",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Rel. Produt. Agentes",$_SESSION["UserRights"]["Guest"]))
		return true;
