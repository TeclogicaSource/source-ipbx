...
function CustomExpression($value,$data,$field,$table="")
{
	...
	if(!$table)
		$table=$strTableName;
	if($table=="ipbx_audit" && $field=="description") 
	{
...
function LookupWhere($field,$table="")
{
	...
	{
		return "name <> 'callcenter' and name <> 'admin'";
	}
...
function GetDefaultValue($field,$table="")
{
	...
	if(!$table)
		$table=$strTableName;
	if($table=="centrocusto" && $field=="flg_ativado") 
	{
		return 1;
	}
	if($table=="sms_noticias" && $field=="dsc_noticia") 
	{
		return "<nome>, texto informativo...";
	}
	if($table=="central" && $field=="dsc_conf_central") 
	{
		return "Configuração das interfaces iPBX";
	}
	if($table=="ipbx_interf_vono" && $field=="id_tp_interf") 
	{
		return 1;
	}
	if($table=="ipbx_interf_fxs" && $field=="id_tp_interf") 
	{
		return 5;
	}
	if($table=="ipbx_interf_e1" && $field=="id_tp_interf") 
	{
		return 2;
	}
	if($table=="ipbx_interf_gsm" && $field=="id_tp_interf") 
	{
		return 3;
	}
	if($table=="ipbx_interf_mslync" && $field=="codec") 
	{
		return "alaw";
	}
	if($table=="ipbx_interf_mslync" && $field=="id_tp_interf") 
	{
		return 9;
	}
	if($table=="ipbx_interf_sip" && $field=="id_tp_interf") 
	{
		return 6;
	}
	if($table=="ipbx_interf_voxip" && $field=="id_tp_interf") 
	{
		return 8;
	}
	if($table=="ipbx_ramais" && $field=="tp_chamada") 
	{
		return 30;
	}
	if($table=="ipbx_backup" && $field=="dt_backup") 
	{
		return now();
	}
	if($table=="Restore" && $field=="dt_backup") 
	{
		return now();
	}
	if($table=="ipbx_interf_callman" && $field=="id_tp_interf") 
	{
		return 10;
	}
	if($table=="Rel. Abandonos" && $field=="dt_entrada") 
	{
		return now();
	}
	if($table=="Rel. Atendimento" && $field=="dt_entrada") 
	{
		return Now();
	}
	if($table=="Rel. Bilhetagem" && $field=="Data") 
	{
		return Now();
	}
	if($table=="Rel. Detalhado - Centro de custo" && $field=="calldate") 
	{
		return now();
	}
	if($table=="Rel. Lig. Discadas" && $field=="Periodo") 
	{
		return Now();
	}
	if($table=="Rel. Recebidas" && $field=="Período") 
	{
		return Now();
	}
	if($table=="Rel. Pesquisa" && $field=="dt_resp") 
	{
		return Now();
	}
	if($table=="Rel. Pesquisa Reversa" && $field=="dt_resp") 
	{
		return Now();
	}
	if($table=="personal_info" && $field=="tp_chamada") 
	{
		return 30;
	}
	if($table=="ipbx_interf_fxo" && $field=="id_tp_interf") 
	{
		return 4;
	}
	if($table=="Rel. Centro de custo" && $field=="periodo") 
	{
		return Now();
	}
	if($table=="ipbx_interf_sip_generica" && $field=="id_tp_interf") 
	{
		return 11;
	}
	if($table=="cc_agentes" && $field=="flg_ativo") 
	{
		return 1;
	}
	if($table=="Rel. Cham Detalhada" && $field=="dt_entrada") 
	{
		return Now();
	}
	if($table=="Rel Produtividade da Fila" && $field=="dt_entrada") 
	{
		return Now();
	}
	if($table=="Rel. Detalhamento Agente" && $field=="dt_entrada") 
	{
		return Now();
	}
	if($table=="Rel. Detalhamento Agente" && $field=="hr_entrada") 
	{
		return now();
	}
	return "";
