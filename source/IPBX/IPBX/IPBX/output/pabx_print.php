...
//	tronco - 
			$value="";
				$value=DisplayLookupWizard("tronco",$data["tronco"],$data,$keylink,MODE_PRINT);
			$record["tronco_value"]=$value;
			if($col<$colsonpage)
...
$xt->assign("tronco_fieldheadercolumn",true);
$xt->assign("tronco_fieldheader",true);
$xt->assign("tronco_fieldcolumn",true);
$xt->assign("tronco_fieldfootercolumn",true);
