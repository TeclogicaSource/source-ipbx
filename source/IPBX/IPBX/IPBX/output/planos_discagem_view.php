...
$arr = array();
$arr['fName'] = "id_plano";
$arr['viewFormat'] = ViewFormat("id_plano", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "DDD";
$arr['viewFormat'] = ViewFormat("DDD", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "id_tronco";
...
//id_plano - 
	$value="";
	$value = ProcessLargeText(GetData($data,"id_plano", ""),"","",MODE_VIEW);
	$xt->assign("id_plano_value",$value);
	$xt->assign("id_plano_fieldblock",true);
////////////////////////////////////////////
//DDD - 
	$value="";
	$value = ProcessLargeText(GetData($data,"DDD", ""),"","",MODE_VIEW);
	$xt->assign("DDD_value",$value);
	$xt->assign("DDD_fieldblock",true);
////////////////////////////////////////////
//id_tronco - 
	$value="";
	$value=DisplayLookupWizard("id_tronco",$data["id_tronco"],$data,$keylink,MODE_VIEW);
...
$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("id_plano")."': '".(jsreplace(@$data["id_plano"]))."', ";
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='planos_discagem_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='planos_discagem_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "planos_discagem_view.htm";
