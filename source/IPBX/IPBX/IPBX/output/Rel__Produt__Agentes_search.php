...
$mode=SEARCH_SIMPLE;
$templatefile = "Rel__Produt__Agentes_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Rel__Produt__Agentes_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Rel__Produt__Agentes';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Produt. Agentes";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Rel__Produt__Agentes_report.php\" ";
	}
