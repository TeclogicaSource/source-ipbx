...
$fieldsArr = array();
$arr = array();
$arr['fName'] = "id_conf_fax";
$arr['viewFormat'] = ViewFormat("id_conf_fax", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "tp_reter_fax";
$arr['viewFormat'] = ViewFormat("tp_reter_fax", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "pasta";
$arr['viewFormat'] = ViewFormat("pasta", $strTableName);
$fieldsArr[] = $arr;
...
//id_conf_fax - 
	$value="";
	$value = ProcessLargeText(GetData($data,"id_conf_fax", ""),"","",MODE_VIEW);
	$xt->assign("id_conf_fax_value",$value);
	$xt->assign("id_conf_fax_fieldblock",true);
////////////////////////////////////////////
//tp_reter_fax - 
	$value="";
	$value = ProcessLargeText(GetData($data,"tp_reter_fax", ""),"","",MODE_VIEW);
	$xt->assign("tp_reter_fax_value",$value);
	$xt->assign("tp_reter_fax_fieldblock",true);
////////////////////////////////////////////
//pasta - 
	$value="";
	$value = ProcessLargeText(GetData($data,"pasta", ""),"","",MODE_VIEW);
	$xt->assign("pasta_value",$value);
	$xt->assign("pasta_fieldblock",true);
 


$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("id_conf_fax")."': '".(jsreplace(@$data["id_conf_fax"]))."', ";
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='ipbx_conf_fax_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='ipbx_conf_fax_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "ipbx_conf_fax_view.htm";
