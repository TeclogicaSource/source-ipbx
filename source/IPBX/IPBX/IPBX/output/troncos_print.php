...
//	id_tronco - 
			$value="";
				$value = ProcessLargeText(GetData($data,"id_tronco", ""),"field=id%5Ftronco".$keylink,"",MODE_PRINT);
			$record["id_tronco_value"]=$value;

//	dsc_tronco - 
			$value="";
				$value = ProcessLargeText(GetData($data,"dsc_tronco", ""),"field=dsc%5Ftronco".$keylink,"",MODE_PRINT);
			$record["dsc_tronco_value"]=$value;

//	channel - 
			$value="";
				$value = ProcessLargeText(GetData($data,"channel", ""),"field=channel".$keylink,"",MODE_PRINT);
			$record["channel_value"]=$value;
...
//	ip_interf - 
			$value="";
				$value = ProcessLargeText(GetData($data,"ip_interf", ""),"field=ip%5Finterf".$keylink,"",MODE_PRINT);
			$record["ip_interf_value"]=$value;

//	mcdu_inicio - 
			$value="";
				$value = ProcessLargeText(GetData($data,"mcdu_inicio", ""),"field=mcdu%5Finicio".$keylink,"",MODE_PRINT);
			$record["mcdu_inicio_value"]=$value;

//	mcdu_fim - 
			$value="";
				$value = ProcessLargeText(GetData($data,"mcdu_fim", ""),"field=mcdu%5Ffim".$keylink,"",MODE_PRINT);
			$record["mcdu_fim_value"]=$value;

//	tp_toques - 
			$value="";
				$value = ProcessLargeText(GetData($data,"tp_toques", ""),"field=tp%5Ftoques".$keylink,"",MODE_PRINT);
			$record["tp_toques_value"]=$value;

//	dig_rota - 
			$value="";
				$value = ProcessLargeText(GetData($data,"dig_rota", ""),"field=dig%5Frota".$keylink,"",MODE_PRINT);
			$record["dig_rota_value"]=$value;
...
$xt->assign("id_tronco_fieldheadercolumn",true);
$xt->assign("id_tronco_fieldheader",true);
$xt->assign("id_tronco_fieldcolumn",true);
$xt->assign("id_tronco_fieldfootercolumn",true);
$xt->assign("dsc_tronco_fieldheadercolumn",true);
$xt->assign("dsc_tronco_fieldheader",true);
$xt->assign("dsc_tronco_fieldcolumn",true);
$xt->assign("dsc_tronco_fieldfootercolumn",true);
$xt->assign("channel_fieldheadercolumn",true);
$xt->assign("channel_fieldheader",true);
$xt->assign("channel_fieldcolumn",true);
$xt->assign("channel_fieldfootercolumn",true);
...
$xt->assign("ip_interf_fieldheadercolumn",true);
$xt->assign("ip_interf_fieldheader",true);
$xt->assign("ip_interf_fieldcolumn",true);
$xt->assign("ip_interf_fieldfootercolumn",true);
$xt->assign("mcdu_inicio_fieldheadercolumn",true);
$xt->assign("mcdu_inicio_fieldheader",true);
$xt->assign("mcdu_inicio_fieldcolumn",true);
$xt->assign("mcdu_inicio_fieldfootercolumn",true);
$xt->assign("mcdu_fim_fieldheadercolumn",true);
$xt->assign("mcdu_fim_fieldheader",true);
$xt->assign("mcdu_fim_fieldcolumn",true);
$xt->assign("mcdu_fim_fieldfootercolumn",true);
$xt->assign("tp_toques_fieldheadercolumn",true);
$xt->assign("tp_toques_fieldheader",true);
$xt->assign("tp_toques_fieldcolumn",true);
$xt->assign("tp_toques_fieldfootercolumn",true);
$xt->assign("dig_rota_fieldheadercolumn",true);
$xt->assign("dig_rota_fieldheader",true);
$xt->assign("dig_rota_fieldcolumn",true);
$xt->assign("dig_rota_fieldfootercolumn",true);
...
$templatefile = "troncos_print.htm";
