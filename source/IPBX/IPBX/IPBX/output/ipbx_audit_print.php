...
//	datetime - Datetime
			$value="";
				$value = ProcessLargeText(GetData($data,"datetime", "Datetime"),"field=datetime".$keylink,"",MODE_PRINT);
...
//	description - Custom
			$value="";
				$value = GetData($data,"description", "Custom");
...
$templatefile = "ipbx_audit_print.htm";
