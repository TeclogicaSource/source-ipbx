...
$mode=SEARCH_SIMPLE;
$templatefile = "Restore_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Restore_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Restore';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Restore";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("dsc_backup");
	...
	{
		$firstFieldParams['fName'] = "dsc_backup";
	...
	$xt->assignbyref("dsc_backup_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("dsc_backup_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("dsc_backup_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_dsc_backup", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("dsc_backup", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("dsc_backup")."', ".$pageObject->id.", ".$ctrlsMap.");";
	...
	{
	$contents_block["begin"].="action=\"Restore_list.php\" ";
	}
