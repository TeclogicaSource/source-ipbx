...
$mode=SEARCH_SIMPLE;
$templatefile = "personal_info_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "personal_info_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'personal_info';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "personal_info";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"personal_info_list.php\" ";
	}
