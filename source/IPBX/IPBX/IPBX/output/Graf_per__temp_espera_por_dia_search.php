...
include("include/Graf_per__temp_espera_por_dia_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Graf_per__temp_espera_por_dia_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Graf_per__temp_espera_por_dia_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Graf_per__temp_espera_por_dia';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Graf. Perfil Tempo de espera por dia";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Graf_per__temp_espera_por_dia_chart.php\" ";
	}
