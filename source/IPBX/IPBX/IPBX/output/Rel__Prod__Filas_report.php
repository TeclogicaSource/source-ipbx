...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Rel__Prod__Filas",
...
$params['shortTName'] = "Rel__Prod__Filas";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "NivelServicoContratado";
$fieldArr['goodName'] = "NivelServicoContratado";
$fieldArr['repPage'] = "1";
$fieldArr['viewFormat'] = "";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Rel__Prod__Filas_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Rel__Prod__Filas_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Rel__Prod__Filas_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Rel__Prod__Filas_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Rel__Prod__Filas_report.htm";
