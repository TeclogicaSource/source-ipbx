...
$mode=SEARCH_SIMPLE;
$templatefile = "Rel__Prod__Filas_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Rel__Prod__Filas_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Rel__Prod__Filas';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Rel. Prod. Filas";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Rel__Prod__Filas_report.php\" ";
	}
