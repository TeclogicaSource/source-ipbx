...
//	id_k_e1 - 
			$value="";
				$value = ProcessLargeText(GetData($data,"id_k_e1", ""),"field=id%5Fk%5Fe1".$keylink,"",MODE_PRINT);
			$record["id_k_e1_value"]=$value;
...
//	include proper masterprint.php code
	...
	$params=array("detailtable"=>"interf_khomp_e1","keys"=>$masterkeys);
	$master=array();
...
$xt->assign("id_k_e1_fieldheadercolumn",true);
$xt->assign("id_k_e1_fieldheader",true);
$xt->assign("id_k_e1_fieldcolumn",true);
$xt->assign("id_k_e1_fieldfootercolumn",true);
...
$templatefile = "interf_khomp_e1_print.htm";
