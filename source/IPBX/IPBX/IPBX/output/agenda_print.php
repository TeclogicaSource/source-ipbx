...
//	solicitante - 
			$value="";
				$value = ProcessLargeText(GetData($data,"solicitante", ""),"field=solicitante".$keylink,"",MODE_PRINT);
			$record["solicitante_value"]=$value;

//	empresa - 
			$value="";
				$value = ProcessLargeText(GetData($data,"empresa", ""),"field=empresa".$keylink,"",MODE_PRINT);
			$record["empresa_value"]=$value;

//	idt_agenda - 
			$value="";
				$value = ProcessLargeText(GetData($data,"idt_agenda", ""),"field=idt%5Fagenda".$keylink,"",MODE_PRINT);
			$record["idt_agenda_value"]=$value;

//	Nome - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Nome", ""),"field=Nome".$keylink,"",MODE_PRINT);
			$record["Nome_value"]=$value;

//	Numero - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Numero", ""),"field=Numero".$keylink,"",MODE_PRINT);
			$record["Numero_value"]=$value;

//	idt_custo - 
			$value="";
				$value=DisplayLookupWizard("idt_custo",$data["idt_custo"],$data,$keylink,MODE_PRINT);
			$record["idt_custo_value"]=$value;
			if($col<$colsonpage)
...
$xt->assign("empresa_fieldheadercolumn",true);
$xt->assign("empresa_fieldheader",true);
$xt->assign("empresa_fieldcolumn",true);
$xt->assign("empresa_fieldfootercolumn",true);
$xt->assign("idt_agenda_fieldheadercolumn",true);
$xt->assign("idt_agenda_fieldheader",true);
$xt->assign("idt_agenda_fieldcolumn",true);
$xt->assign("idt_agenda_fieldfootercolumn",true);
...
$xt->assign("idt_custo_fieldheadercolumn",true);
$xt->assign("idt_custo_fieldheader",true);
$xt->assign("idt_custo_fieldcolumn",true);
$xt->assign("idt_custo_fieldfootercolumn",true);
