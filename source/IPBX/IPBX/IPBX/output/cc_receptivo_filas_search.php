...
$mode=SEARCH_SIMPLE;
$templatefile = "cc_receptivo_filas_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "cc_receptivo_filas_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'cc_receptivo_filas';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "cc_receptivo_filas";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("nm_fila");
	...
	{
		$firstFieldParams['fName'] = "nm_fila";
	...
	$xt->assignbyref("nm_fila_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("nm_fila_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("nm_fila_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_nm_fila", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("nm_fila", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("nm_fila")."', ".$pageObject->id.", ".$ctrlsMap.");";
	...
	{
	$contents_block["begin"].="action=\"cc_receptivo_filas_list.php\" ";
	}
