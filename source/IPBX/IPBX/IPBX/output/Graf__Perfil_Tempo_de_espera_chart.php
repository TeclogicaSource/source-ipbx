...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Graf__Perfil_Tempo_de_espera",
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Graf__Perfil_Tempo_de_espera_search.php';return false;\"");
$xt->assign("search_records_block",true);
//$xt->assign("recordcontrols_block",true);

$xt->assign("searchform_showall",true);
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Graf__Perfil_Tempo_de_espera_chart.php?a=showall';\"");

if(!GetChartXML("Graf__Perfil_Tempo_de_espera"))
...
$templatefile = "Graf__Perfil_Tempo_de_espera_chart.htm";
