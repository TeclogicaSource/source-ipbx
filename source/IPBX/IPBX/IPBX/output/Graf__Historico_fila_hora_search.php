...
include("include/Graf__Historico_fila_hora_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Graf__Historico_fila_hora_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Graf__Historico_fila_hora_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Graf__Historico_fila_hora';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Graf. Historico fila hora";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Graf__Historico_fila_hora_chart.php\" ";
	}
