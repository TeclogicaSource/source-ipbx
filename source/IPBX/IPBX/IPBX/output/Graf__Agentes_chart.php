...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Graf__Agentes_search.php';return false;\"");
$xt->assign("search_records_block",true);
//$xt->assign("recordcontrols_block",true);

$xt->assign("searchform_showall",true);
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Graf__Agentes_chart.php?a=showall';\"");

if(!GetChartXML("Graf__Agentes"))
...
$templatefile = "Graf__Agentes_chart.htm";
