...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"Lig__Externas_Transferidas",
...
$params['shortTName'] = "Lig__Externas_Transferidas";
...
$fieldArr = array();
$fieldArr['name'] = "Data/Hora Ligacao";
$fieldArr['goodName'] = "Data_Hora_Ligacao";
$fieldArr['repPage'] = "0";
$fieldArr['viewFormat'] = "Short Date";
$fieldArr['editFormat'] = "Date";
$fieldArr['thumbnail'] = "";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='Lig__Externas_Transferidas_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='Lig__Externas_Transferidas_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('Lig__Externas_Transferidas_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('Lig__Externas_Transferidas_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "Lig__Externas_Transferidas_report.htm";
