...
$pageObject->body["begin"] .="<form action=\"Atendimento_export.php\" method=POST id=frmexport name=frmexport>";
$pageObject->body["end"] .= "</form><script>".$pageObject->PrepareJS()."</script>";
$xt->assignbyref("body",$pageObject->body);

$xt->display("Atendimento_export.htm");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=Atendimento.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=Atendimento.csv");
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Tempo Total").'</td>';	
