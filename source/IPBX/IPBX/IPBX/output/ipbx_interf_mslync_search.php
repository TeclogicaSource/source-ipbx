...
include("include/ipbx_interf_mslync_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "ipbx_interf_mslync_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "ipbx_interf_mslync_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'ipbx_interf_mslync';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "ipbx_interf_mslync";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("flg_id_cham_parc");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "flg_id_cham_parc";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("flg_id_cham_parc_label","<label for=\"".GetInputElementId("flg_id_cham_parc", $id)."\">","</label>");
	else 
		$xt->assign("flg_id_cham_parc_label", true);
	
	$xt->assign("flg_id_cham_parc_fieldblock", true);		
	$xt->assignbyref("flg_id_cham_parc_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("flg_id_cham_parc_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("flg_id_cham_parc_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_flg_id_cham_parc", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("flg_id_cham_parc", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("flg_id_cham_parc")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	...
	{
	$contents_block["begin"].="action=\"ipbx_interf_mslync_list.php\" ";
	}
