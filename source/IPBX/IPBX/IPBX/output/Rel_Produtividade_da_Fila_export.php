...
include("include/Rel_Produtividade_da_Fila_variables.php");
...
$pageObject->body["begin"] .="<form action=\"Rel_Produtividade_da_Fila_export.php\" method=POST id=frmexport name=frmexport>";
$pageObject->body["end"] .= "</form><script>".$pageObject->PrepareJS()."</script>";
$xt->assignbyref("body",$pageObject->body);

$xt->display("Rel_Produtividade_da_Fila_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=Rel_Produtividade_da_Fila.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=Rel_Produtividade_da_Fila.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=Rel_Produtividade_da_Fila.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=Rel_Produtividade_da_Fila.csv");
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Qtd. Receb.").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Qtd. Atentend.").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Qtd. Aband.").'</td>';	
	...
	{
		echo "<td>"."Data"."</td>";
		echo "<td>"."Qtd. Receb."."</td>";
		echo "<td>"."Qtd. Atentend."."</td>";
		echo "<td>"."Qtd. Aband."."</td>";
		echo "<td>"."TME"."</td>";
		echo "<td>"."TMA"."</td>";
		echo "<td>"."TMO"."</td>";
		echo "<td>"."Abd.Cont."."</td>";
