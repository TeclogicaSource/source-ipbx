...
$params = array("id" =>$id, 
				...
				"shortTableName"=>"ipbx_fila_pesquisa_ura_rev_resp_Report",
...
$params['shortTName'] = "ipbx_fila_pesquisa_ura_rev_resp_Report";
...
if($maxpages>1)
{
	...
	$pageObject->addJSCode("WritePagination(".$mypage.",".$maxpages.", ".$id.");
		...
		{
			window.location='ipbx_fila_pesquisa_ura_rev_resp_Report_report.php?goto='+nPageNumber;
		}
	");
...
$xt->assign("asearchlink_attrs","onclick=\"window.location.href='ipbx_fila_pesquisa_ura_rev_resp_Report_search.php';return false;\"");
$xt->assign("print_link",$allow_export);
$xt->assign("printall_link",$allow_export);
$xt->assign("export_link",$allow_export);
$xt->assign("printlink_attrs","onclick=\"window.open('ipbx_fila_pesquisa_ura_rev_resp_Report_print.php','wPrint');return false;\"");
$xt->assign("printalllink_attrs","onclick=\"window.open('ipbx_fila_pesquisa_ura_rev_resp_Report_print.php?all=1','wPrint');return false;\"");
...
$templatefile = "ipbx_fila_pesquisa_ura_rev_resp_Report_report.htm";
