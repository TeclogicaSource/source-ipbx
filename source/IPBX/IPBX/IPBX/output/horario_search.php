...
$mode=SEARCH_SIMPLE;
$templatefile = "horario_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "horario_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'horario';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "horario";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"horario_list.php\" ";
	}
