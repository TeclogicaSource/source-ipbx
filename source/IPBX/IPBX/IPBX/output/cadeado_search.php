...
$mode=SEARCH_SIMPLE;
$templatefile = "cadeado_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "cadeado_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'cadeado';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "cadeado";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("dt_ativacao");
	...
	{
		$firstFieldParams['fName'] = "dt_ativacao";
	...
	if(isEnableSection508())
		$xt->assign_section("dt_ativacao_label","<label for=\"".GetInputElementId("dt_ativacao", $id)."\">","</label>");
	else 
		$xt->assign("dt_ativacao_label", true);
	
	$xt->assign("dt_ativacao_fieldblock", true);		
	$xt->assignbyref("dt_ativacao_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("dt_ativacao_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("dt_ativacao_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_dt_ativacao", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("dt_ativacao", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("dt_ativacao")."', ".$pageObject->id.", ".$ctrlsMap.");";
	...
	{
	$contents_block["begin"].="action=\"cadeado_list.php\" ";
	}
