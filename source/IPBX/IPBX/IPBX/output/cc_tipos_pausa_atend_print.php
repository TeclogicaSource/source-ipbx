...
//	idt_pausa_atend - 
			$value="";
				$value = ProcessLargeText(GetData($data,"idt_pausa_atend", ""),"field=idt%5Fpausa%5Fatend".$keylink,"",MODE_PRINT);
			$record["idt_pausa_atend_value"]=$value;

//	dt_acao_pausa - Short Date
			$value="";
				$value = ProcessLargeText(GetData($data,"dt_acao_pausa", "Short Date"),"field=dt%5Facao%5Fpausa".$keylink,"",MODE_PRINT);
			$record["dt_acao_pausa_value"]=$value;

//	hr_acao_pausa - Time
			$value="";
				$value = ProcessLargeText(GetData($data,"hr_acao_pausa", "Time"),"field=hr%5Facao%5Fpausa".$keylink,"",MODE_PRINT);
			$record["hr_acao_pausa_value"]=$value;

//	tp_pausa - Time
			$value="";
				$value = ProcessLargeText(GetData($data,"tp_pausa", "Time"),"field=tp%5Fpausa".$keylink,"",MODE_PRINT);
			$record["tp_pausa_value"]=$value;

//	Agente - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Agente", ""),"field=Agente".$keylink,"",MODE_PRINT);
			$record["Agente_value"]=$value;
...
//	Fila - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Fila", ""),"field=Fila".$keylink,"",MODE_PRINT);
			$record["Fila_value"]=$value;

//	tipo_pausa - 
			$value="";
				$value = ProcessLargeText(GetData($data,"tipo_pausa", ""),"field=tipo%5Fpausa".$keylink,"",MODE_PRINT);
			$record["tipo_pausa_value"]=$value;
			if($col<$colsonpage)
...
$xt->assign("idt_pausa_atend_fieldheadercolumn",true);
$xt->assign("idt_pausa_atend_fieldheader",true);
$xt->assign("idt_pausa_atend_fieldcolumn",true);
$xt->assign("idt_pausa_atend_fieldfootercolumn",true);
$xt->assign("dt_acao_pausa_fieldheadercolumn",true);
$xt->assign("dt_acao_pausa_fieldheader",true);
$xt->assign("dt_acao_pausa_fieldcolumn",true);
$xt->assign("dt_acao_pausa_fieldfootercolumn",true);
$xt->assign("hr_acao_pausa_fieldheadercolumn",true);
$xt->assign("hr_acao_pausa_fieldheader",true);
$xt->assign("hr_acao_pausa_fieldcolumn",true);
$xt->assign("hr_acao_pausa_fieldfootercolumn",true);
$xt->assign("tp_pausa_fieldheadercolumn",true);
$xt->assign("tp_pausa_fieldheader",true);
$xt->assign("tp_pausa_fieldcolumn",true);
$xt->assign("tp_pausa_fieldfootercolumn",true);
$xt->assign("Agente_fieldheadercolumn",true);
$xt->assign("Agente_fieldheader",true);
$xt->assign("Agente_fieldcolumn",true);
$xt->assign("Agente_fieldfootercolumn",true);
...
$xt->assign("Fila_fieldheadercolumn",true);
$xt->assign("Fila_fieldheader",true);
$xt->assign("Fila_fieldcolumn",true);
$xt->assign("Fila_fieldfootercolumn",true);
$xt->assign("tipo_pausa_fieldheadercolumn",true);
$xt->assign("tipo_pausa_fieldheader",true);
$xt->assign("tipo_pausa_fieldcolumn",true);
$xt->assign("tipo_pausa_fieldfootercolumn",true);
...
$templatefile = "cc_tipos_pausa_atend_print.htm";
