...
include("include/Contatos_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Contatos_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Contatos_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Contatos';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Contatos";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Contatos_list.php\" ";
	}
