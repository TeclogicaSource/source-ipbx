...
// keys array
$keys[]=AddFieldWrappers("idt_siga");
$keys_present=1;
...
$pageObject->body["begin"] .="<FORM name=frmimport id=frmimport action=\"sigame_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='sigame_list.php?a=return';\"");
