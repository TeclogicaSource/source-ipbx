...
$fieldsArr = array();
$arr = array();
$arr['fName'] = "id_ms_lync";
$arr['viewFormat'] = ViewFormat("id_ms_lync", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "ip_host";
$arr['viewFormat'] = ViewFormat("ip_host", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "port";
$arr['viewFormat'] = ViewFormat("port", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "codec";
$arr['viewFormat'] = ViewFormat("codec", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "id_central";
$arr['viewFormat'] = ViewFormat("id_central", $strTableName);
$fieldsArr[] = $arr;
...
//id_ms_lync - 
	$value="";
	$value = ProcessLargeText(GetData($data,"id_ms_lync", ""),"","",MODE_VIEW);
	$xt->assign("id_ms_lync_value",$value);
	$xt->assign("id_ms_lync_fieldblock",true);
////////////////////////////////////////////
//ip_host - 
	$value="";
	$value = ProcessLargeText(GetData($data,"ip_host", ""),"","",MODE_VIEW);
	$xt->assign("ip_host_value",$value);
	$xt->assign("ip_host_fieldblock",true);
////////////////////////////////////////////
//port - 
	$value="";
	$value = ProcessLargeText(GetData($data,"port", ""),"","",MODE_VIEW);
	$xt->assign("port_value",$value);
	$xt->assign("port_fieldblock",true);
////////////////////////////////////////////
//codec - 
	$value="";
	$value = ProcessLargeText(GetData($data,"codec", ""),"","",MODE_VIEW);
	$xt->assign("codec_value",$value);
	$xt->assign("codec_fieldblock",true);
////////////////////////////////////////////
//id_central - 
	$value="";
	$value = ProcessLargeText(GetData($data,"id_central", ""),"","",MODE_VIEW);
	$xt->assign("id_central_value",$value);
	$xt->assign("id_central_fieldblock",true);
 


$jsKeysObj = 'window.recKeysObj = {';
	$jsKeysObj .= "'".jsreplace("id_ms_lync")."': '".(jsreplace(@$data["id_ms_lync"]))."', ";
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='interf_ms_lync_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='interf_ms_lync_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "interf_ms_lync_view.htm";
