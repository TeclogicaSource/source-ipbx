...
$mode=SEARCH_SIMPLE;
$templatefile = "sms_clientes_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "sms_clientes_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'sms_clientes';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "sms_clientes";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"sms_clientes_list.php\" ";
	}
