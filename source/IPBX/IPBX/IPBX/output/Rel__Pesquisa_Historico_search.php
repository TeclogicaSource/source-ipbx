...
include("include/Rel__Pesquisa_Historico_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Rel__Pesquisa_Historico_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Rel__Pesquisa_Historico_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Rel__Pesquisa_Historico';
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Rel__Pesquisa_Historico_report.php\" ";
	}
