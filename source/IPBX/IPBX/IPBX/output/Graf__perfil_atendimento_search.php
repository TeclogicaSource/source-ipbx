...
include("include/Graf__perfil_atendimento_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Graf__perfil_atendimento_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Graf__perfil_atendimento_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Graf__perfil_atendimento';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Graf. perfil atendimento";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Graf__perfil_atendimento_chart.php\" ";
	}
