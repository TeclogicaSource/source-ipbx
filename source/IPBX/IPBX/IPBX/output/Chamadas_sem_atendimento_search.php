...
include("include/Chamadas_sem_atendimento_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Chamadas_sem_atendimento_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Chamadas_sem_atendimento_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Chamadas_sem_atendimento';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Graf. Chamadas sem atendimento";
...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("Agentes");
	...
	{
		$firstFieldParams['fName'] = "Agentes";
	...
	if(isEnableSection508())
		$xt->assign_section("Agentes_label","<label for=\"".GetInputElementId("Agentes", $id)."\">","</label>");
	else 
		$xt->assign("Agentes_label", true);
	
	$xt->assign("Agentes_fieldblock", true);		
	$xt->assignbyref("Agentes_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("Agentes_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("Agentes_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_Agentes", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS("Agentes", $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('".jsreplace("Agentes")."', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	...
	{
	$contents_block["begin"].="action=\"Chamadas_sem_atendimento_chart.php\" ";
	}
